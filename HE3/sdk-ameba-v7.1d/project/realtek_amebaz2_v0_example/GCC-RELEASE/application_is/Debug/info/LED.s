...
.Ltext0:
	...
	.section	.text.initialize_Htap_LED,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	initialize_Htap_LED
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	initialize_Htap_LED, %function
initialize_Htap_LED:
.LFB560:
	.file 1 "../src/hoags/device_controls/light/src/LED.c"
	.loc 1 20 0
	.cfi_startproc
...
.LBE31:
	.cfi_endproc
.LFE560:
	.size	initialize_Htap_LED, .-initialize_Htap_LED
	.section	.text.init_htap_led,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	init_htap_led
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	init_htap_led, %function
init_htap_led:
.LFB561:
	.loc 1 46 0
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE561:
	.size	init_htap_led, .-init_htap_led
	.section	.text.set_led_blink_speed,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	set_led_blink_speed
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	set_led_blink_speed, %function
set_led_blink_speed:
.LFB562:
	.loc 1 53 0
	.cfi_startproc
...
.LVL20:
	.cfi_endproc
.LFE562:
	.size	set_led_blink_speed, .-set_led_blink_speed
	.section	.text.wakeword_det_led_on,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	wakeword_det_led_on
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	wakeword_det_led_on, %function
wakeword_det_led_on:
.LFB563:
	.loc 1 62 0
	.cfi_startproc
...
.L13:
	...
	.cfi_endproc
.LFE563:
	.size	wakeword_det_led_on, .-wakeword_det_led_on
	.section	.text.mic_mute_led,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	mic_mute_led
	.syntax unified
...
.L17:
	...
	.cfi_endproc
.LFE564:
	.size	mic_mute_led, .-mic_mute_led
	.section	.text.wifi_ble_conn,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	wifi_ble_conn
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	wifi_ble_conn, %function
wifi_ble_conn:
.LFB565:
	.loc 1 111 0
	.cfi_startproc
...
.L21:
	...
	.cfi_endproc
.LFE565:
	.size	wifi_ble_conn, .-wifi_ble_conn
	.section	.text.wifi_ble_disconn,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	wifi_ble_disconn
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	wifi_ble_disconn, %function
wifi_ble_disconn:
.LFB566:
	.loc 1 122 0
	.cfi_startproc
...
.L25:
	...
	.cfi_endproc
.LFE566:
	.size	wifi_ble_disconn, .-wifi_ble_disconn
	.section	.text.ota_update_mod_tranfer,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	ota_update_mod_tranfer
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	ota_update_mod_tranfer, %function
ota_update_mod_tranfer:
.LFB567:
	.loc 1 133 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 160
...
.L29:
	...
	.cfi_endproc
.LFE567:
	.size	ota_update_mod_tranfer, .-ota_update_mod_tranfer
	.section	.text.WW_LEDNoColor,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	WW_LEDNoColor
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	WW_LEDNoColor, %function
WW_LEDNoColor:
.LFB568:
	.loc 1 145 0
	.cfi_startproc
...
.LBE39:
	.cfi_endproc
.LFE568:
	.size	WW_LEDNoColor, .-WW_LEDNoColor
	.section	.text.cmd_det_led_off,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	cmd_det_led_off
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	cmd_det_led_off, %function
cmd_det_led_off:
.LFB569:
	.loc 1 151 0
	.cfi_startproc
...
.L37:
	...
	.cfi_endproc
.LFE569:
	.size	cmd_det_led_off, .-cmd_det_led_off
	.section	.text.cmd_det_fail_led_off,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	cmd_det_fail_led_off
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	cmd_det_fail_led_off, %function
cmd_det_fail_led_off:
.LFB570:
	.loc 1 169 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 160
...
.L41:
	...
	.cfi_endproc
.LFE570:
	.size	cmd_det_fail_led_off, .-cmd_det_fail_led_off
	.section	.text.blink_LED,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	blink_LED
	.syntax unified
...
.LFE571:
	...
	.section	.text.breathe_LED,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	breathe_LED
	.syntax unified
...
.L56:
	...
	.cfi_endproc
.LFE572:
	.size	breathe_LED, .-breathe_LED
	.section	.text.led_always_on,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	led_always_on
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	led_always_on, %function
led_always_on:
.LFB573:
	.loc 1 226 0
	.cfi_startproc
...
.LBE61:
	.cfi_endproc
.LFE573:
	.size	led_always_on, .-led_always_on
	.section	.text.led_always_off,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	led_always_off
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	led_always_off, %function
led_always_off:
.LFB574:
	.loc 1 232 0
	.cfi_startproc
...
.LBE65:
	.cfi_endproc
.LFE574:
	.size	led_always_off, .-led_always_off
	.global	htapledPtr
	.comm	htap_led_obj,120,4
	.comm	superFanObj,388,4
	.section	.data.htapledPtr,"aw",%progbits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	htapledPtr, %object
	.size	htapledPtr, 4
htapledPtr:
	.word	htap_led_obj
	...
	.size	__func__.20990, 20
__func__.20990:
	.ascii	"initialize_Htap_LED\000"
	.section	.rodata.__func__.20999,"a",%progbits
	.align	2
	.set	.LANCHOR2,. + 0
	.type	__func__.20999, %object
	.size	__func__.20999, 14
__func__.20999:
	.ascii	"init_htap_led\000"
	.section	.rodata.initialize_Htap_LED.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
...
.Letext0:
	...
	.file 47 "../../../component/common/mbed/hal/pwmout_api.h"
	.file 48 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/arm-none-eabi/include/stdlib.h"
	.file 49 "../../../component/common/network/lwip/lwip_v2.0.2/src/include/lwip/errno.h"
	.file 50 "../src/hoags/hoags_config.h"
	.file 51 "../src/hoags/ble/include/packets.h"
	.file 52 "../src/hoags/device_controls/fan/include/fan.h"
	.file 53 "../src/hoags/device_controls/light/include/LED.h"
	.file 54 "../../../component/os/freertos/freertos_v10.0.1/Source/include/task.h"
	.file 55 "../../../component/common/api/platform/platform_stdlib_rtl8710c.h"
	.file 56 "../../../component/common/mbed/targets/hal/rtl8710c/PinNames.h"
...
.LASF1441:
	.ascii	"COMMAND_NOT_DETECTED\000"
.LASF741:
...
.LASF611:
	.ascii	"memcpy\000"
.LASF1477:
	.ascii	"cmd_det_fail_led_off\000"
.LASF707:
...
.LASF1505:
	.ascii	"../src/hoags/device_controls/light/src/LED.c\000"
.LASF958:
...
.LASF1443:
	.ascii	"OTA_OR_MODEL_TRANSFER\000"
.LASF277:
...
.LASF288:
	.ascii	"rbr_b\000"
.LASF1447:
	.ascii	"WIFI_OR_BLE_CONNECTED\000"
.LASF41:
	.ascii	"__tm_mon\000"
.LASF599:
...
.LASF1438:
	.ascii	"DEV_CMD_STATE\000"
.LASF1470:
	.ascii	"htap_led_obj\000"
.LASF225:
	.ascii	"PWM0_Type\000"
.LASF570:
	.ascii	"initialed\000"
.LASF1482:
	.ascii	"ota_update_mod_tranfer\000"
.LASF255:
	.ascii	"sw_cts\000"
.LASF1219:
