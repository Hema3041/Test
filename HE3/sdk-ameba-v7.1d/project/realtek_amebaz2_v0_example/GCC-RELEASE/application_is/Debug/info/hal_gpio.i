# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
# 36 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_gpio.h" 1
# 31 "../../../component/soc/realtek/8710c/fwlib/include/hal_gpio.h"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/include/hal_gpio.h" 2
...
# 37 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c" 2
...
hal_status_t hal_pinmux_unregister (uint8_t pin_name, uint8_t periphl_id);
# 38 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c" 2
# 46 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
const uint32_t *pport_in_en_reg[1] = {
    (uint32_t *)&(((GPIO_Type*) 0x40001000UL)->port_a_idm_en)
};




const uint32_t *pport_out_en_reg[1] = {
    (uint32_t *)&(((GPIO_Type*) 0x40001000UL)->port_a_odm_en)
};
# 69 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
hal_status_t hal_gpio_init (phal_gpio_adapter_t pgpio_adapter, uint32_t pin_name)
{
    hal_status_t ret;
...
# 87 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
void hal_gpio_deinit (phal_gpio_adapter_t pgpio_adapter)
{
    hal_pinmux_unregister(pgpio_adapter->pin_name, PID_GPIO);
    hal_gpio_stubs.hal_gpio_deinit (pgpio_adapter);
}
# 110 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
hal_status_t hal_gpio_irq_init (phal_gpio_irq_adapter_t pgpio_irq_adapter, uint32_t pin_name,
                                gpio_irq_callback_t callback, uint32_t arg)
{
    hal_status_t ret;
...
# 130 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
void hal_gpio_irq_deinit (phal_gpio_irq_adapter_t pgpio_irq_adapter)
{
    hal_pinmux_unregister(pgpio_irq_adapter->pin_name, PID_GPIO);
    hal_gpio_stubs.hal_gpio_irq_deinit (pgpio_irq_adapter);
}
# 153 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
hal_status_t hal_gpio_port_init (phal_gpio_port_adapter_t pgpio_port_adapter, uint32_t port_idx,
                                 uint32_t mask, gpio_dir_t dir)
{
...
# 186 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
void hal_gpio_port_deinit (phal_gpio_port_adapter_t pgpio_port_adapter)
{
    gpio_pin_t pin;
    uint32_t i;
...
# 213 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
void hal_gpio_port_dir (phal_gpio_port_adapter_t pgpio_port_adapter, gpio_dir_t dir)
{
...
# 239 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gpio.c"
void hal_gpio_h5l3 (uint8_t h5l3)
{
    uint32_t buff = 0;
    buff = ((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0xAC))));
    ...
    ((*((volatile uint32_t*)(0x40000000 + 0xAC))) = ((uint32_t)(buff)));
}
