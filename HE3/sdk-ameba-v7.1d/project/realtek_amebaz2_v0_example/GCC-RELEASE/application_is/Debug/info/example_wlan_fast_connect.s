...
.LVL48:
	...
	mov	r1, r0
	str	r0, [sp, #92]
	ldrb	fp, [sp, #40]	@ zero_extendqisi2
	ldr	r7, [sp, #88]
	.loc 1 148 0
	b	.L24
.LVL49:
...
offer_ip:
	.space	4
	.section	.rodata.__func__.22555,"a",%progbits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__func__.22555, %object
	.size	__func__.22555, 35
__func__.22555:
	.ascii	"wlan_write_reconnect_data_to_flash\000"
	.section	.rodata.wlan_init_done_callback.str1.4,"aMS",%progbits,1
	.align	2
.LC1:
...
.LC3:
	...
	.section	.rodata.wlan_write_reconnect_data_to_flash.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
...
.Letext0:
	...
	.file 70 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/arm-none-eabi/include/stdio.h"
	.file 71 "../../../component/common/api/wifi/wifi_conf.h"
	.file 72 "../../../component/common/api/platform/platform_stdlib_rtl8710c.h"
