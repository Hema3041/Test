# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
# 29 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_spic.h" 1
# 31 "../../../component/soc/realtek/8710c/fwlib/include/hal_spic.h"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/include/hal_spic.h" 2
...
# 30 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 2
...
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 2
...
hal_status_t hal_pinmux_unregister (uint8_t pin_name, uint8_t periphl_id);
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_spic_type.h" 1
# 48 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_spic_type.h"
typedef union {
  volatile uint32_t w;
...
# 33 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 2
...
# 35 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 2
...
__attribute__ ((__section__(".ram.bss.noinit"))) hal_spic_adaptor_t hal_spic_adaptor;
...
# 79 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_load_default_setting(pspic_init_para_t pspic_init_data)
{
    hal_spic_stubs.spic_load_default_setting(pspic_init_data);
}
# 93 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
uint8_t spic_query_system_clk(void)
{
    return hal_spic_stubs.spic_query_system_clk();
}
# 106 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_clock_ctrl(uint8_t ctl)
{
    hal_spic_stubs.spic_clock_ctrl(ctl);
}
# 126 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
hal_status_t spic_init_setting(phal_spic_adaptor_t phal_spic_adaptor, uint8_t spic_bit_mode)
{
    return hal_spic_stubs.spic_init_setting(phal_spic_adaptor, spic_bit_mode);
}
# 140 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_config_auto_mode(phal_spic_adaptor_t phal_spic_adaptor)
{
    ...
    valid_cmd.w = 0;
    valid_cmd.b.wr_blocking = 1;
    valid_cmd.b.prm_en = 1;
    ...
    switch (spic_bit_mode) {
        ...
        case SpicQuadIOMode:
            ...
            spic_dev->valid_cmd_b.rd_quad_io = 1;
            hal_flash_set_quad_enable(phal_spic_adaptor);
            break;
        ...
        default:
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "spic_config_auto_mode_rtl8710c : Invalid Bit Mode\r\n"));}while(0);
    }
...
# 215 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_config_user_mode(phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_spic_stubs.spic_config_user_mode(phal_spic_adaptor);
}
# 228 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
BOOL spic_verify_calibration_para(void)
{
    return hal_spic_stubs.spic_verify_calibration_para();
}
# 242 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_set_chnl_num(phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_spic_stubs.spic_set_chnl_num(phal_spic_adaptor);
}
# 256 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_set_delay_line(uint8_t delay_line)
{
    hal_spic_stubs.spic_set_delay_line(delay_line);
}
# 272 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_rx_cmd(phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t data_phase_len, uint8_t *pdata)
{
    hal_spic_stubs.spic_rx_cmd(phal_spic_adaptor, cmd, data_phase_len, pdata);
}
# 288 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_tx_cmd_no_check(phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t data_phase_len, uint8_t *pdata)
{
    hal_spic_stubs.spic_tx_cmd_no_check(phal_spic_adaptor, cmd, data_phase_len, pdata);
}
# 304 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_tx_cmd(phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t data_phase_len, uint8_t *pdata)
{
    hal_spic_stubs.spic_tx_cmd(phal_spic_adaptor, cmd, data_phase_len,pdata);
}
# 317 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_wait_ready(SPIC_Type *spic_dev)
{
    hal_spic_stubs.spic_wait_ready(spic_dev);
}
# 330 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_flush_fifo(SPIC_Type *spic_dev)
{
    hal_spic_stubs.spic_flush_fifo(spic_dev);
}
# 345 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
hal_status_t spic_pinmux_ctl(phal_spic_adaptor_t phal_spic_adaptor, uint8_t ctl)
{
    hal_status_t ret;
    uint8_t quad_pin_sel = phal_spic_adaptor->quad_pin_sel;
    pflash_pin_sel_t pflash_pin_sel = &(phal_spic_adaptor->flash_pin_sel);
# 374 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
    if (ctl == 1) {
        ret = hal_pinmux_register(pflash_pin_sel->pin_cs, PID_FLASH);
        ret |= hal_pinmux_register(pflash_pin_sel->pin_clk, PID_FLASH);
        ret |= hal_pinmux_register(pflash_pin_sel->pin_d0, PID_FLASH);
        ret |= hal_pinmux_register(pflash_pin_sel->pin_d1, PID_FLASH);

        if (quad_pin_sel) {
            ret |= hal_pinmux_register(pflash_pin_sel->pin_d2, PID_FLASH);
            ret |= hal_pinmux_register(pflash_pin_sel->pin_d3, PID_FLASH);
        }
    } else {
        ret = hal_pinmux_unregister(pflash_pin_sel->pin_cs, PID_FLASH);
        ret |= hal_pinmux_unregister(pflash_pin_sel->pin_clk, PID_FLASH);
        ret |= hal_pinmux_unregister(pflash_pin_sel->pin_d0, PID_FLASH);
        ret |= hal_pinmux_unregister(pflash_pin_sel->pin_d1, PID_FLASH);

        if (quad_pin_sel) {
            ret |= hal_pinmux_unregister(pflash_pin_sel->pin_d2, PID_FLASH);
            ret |= hal_pinmux_unregister(pflash_pin_sel->pin_d3, PID_FLASH);
...
# 414 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
hal_status_t spic_init(phal_spic_adaptor_t phal_spic_adaptor, uint8_t spic_bit_mode, pflash_pin_sel_t pflash_pin_sel)
{
    pflash_dummy_cycle_t dummy_cycle;
    SPIC_Type *spic_dev;
    ...
    if (spic_pinmux_ctl(phal_spic_adaptor, 1) == (0x00)) {
        if (spic_init_setting(phal_spic_adaptor, spic_bit_mode) != (0x00)) {
            return (0x05);
        }
    } else {
        return (0x03);
    ...
    if (spic_calibration(phal_spic_adaptor, default_dummy_cycle) != (!0)) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "spic_init : Calibration Fail, switch back to one bit mode!\r\n"));}while(0);
...
# 488 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
hal_status_t spic_deinit(phal_spic_adaptor_t phal_spic_adaptor)
{
    spic_pinmux_ctl(phal_spic_adaptor, 0);
...
# 510 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
BOOL spic_calibration(phal_spic_adaptor_t phal_spic_adaptor, uint32_t default_dummy_cycle)
{
    SPIC_Type *spic_dev = phal_spic_adaptor->spic_dev;
    ...
    if (pspic_init_para->valid) {
        ...
        if (spic_verify_calibration_para() == (!0)) {
            return (!0);
        }
    }

    do { if (__builtin_expect (((*(utility_stubs.config_debug_info)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Inf]" "Start Flash Calibration\r\n"));}while(0);
    ...
    for (baudr = min_baud_rate; baudr <= 0x06; baudr++) {
        spic_disable_rtl8710c(spic_dev);
        spic_set_baudr_rtl8710c(spic_dev, baudr);
        spic_set_fbaudr_rtl8710c(spic_dev, baudr);
        spic_enable_rtl8710c(spic_dev);

        for (auto_len = (default_dummy_cycle*baudr*2); auto_len < (default_dummy_cycle*baudr*2 + 0x14); auto_len++) {
            spic_disable_rtl8710c(spic_dev);
            ...
            if (spic_verify_calibration_para() == (!0)) {
                if (last_pass == 0) {
                    ...
                    if (auto_len == (default_dummy_cycle*baudr*2 + 0x14) - 1) {
                        tmp_end_pt = auto_len;
                        if (tmp_max_wd < (tmp_end_pt - tmp_str_pt)) {
                            tmp_max_str = tmp_str_pt;
                            tmp_max_end = tmp_end_pt;
                            tmp_max_wd = tmp_end_pt - tmp_str_pt;
                            do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Wrn]" "tmp_max_str = %x, tmp_max_end = %x\r\n", tmp_max_str, tmp_max_end));}while(0);
                        }
                    }
                }
        ...
        if (tmp_max_wd) {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_info)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Inf]" "Find the avaiable window\r\n"));}while(0);
            break;
        }
    }
    ...
    if (tmp_max_wd == 0) {
        ...
        do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Wrn]" "Baud:%x; dc start:%x; dc end:%x\n",baudr, tmp_max_str, tmp_max_end));}while(0);
...
# 805 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_load_calibration_setting(phal_spic_adaptor_t phal_spic_adaptor)
{
    uint8_t spic_bit_mode = phal_spic_adaptor->spic_bit_mode;
    uint8_t cpu_type = spic_query_system_clk();
    ...
    spic_disable_rtl8710c(spic_dev);
    spic_dev->auto_length_b.auto_addr_length = phal_spic_adaptor->addr_byte_num;
    spic_data = ((uint32_t)(*((volatile uint32_t*)(0x98000000 + 0x1040 + data_offset))));
    spic_data_inv = ((uint32_t)(*((volatile uint32_t*)(0x98000000 + 0x1040 + data_offset + 4))));
    ...
    if (spic_data != 0xFFFFFFFF) {
        if (0xFFFFFFFF == (spic_data^spic_data_inv)) {
            ...
            if (spic_verify_calibration_para() == (!0)) {
                ...
                do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Wrn]" "Bit mode %d, Calibration setting loaded from flash. 0x%x\r\n", spic_bit_mode, spic_data));}while(0);
            } else {
                hal_flash_return_spi(phal_spic_adaptor);
                do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "Bit mode %d setting cannot work, switch back to one IO mode. 0x%x\n",spic_bit_mode, spic_data));}while(0);
            }
        } else {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Wrn]" "spic_load_calibration_setting: Data in Flash(@ 0x%x = 0x%x 0x%x) is Invalid\r\n", (0x1040 +data_offset), spic_data, spic_data_inv));}while(0)
                                                                       ;
        }
    }
}
# 860 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_store_calibration_setting(phal_spic_adaptor_t phal_spic_adaptor)
{
    uint8_t spic_bit_mode = phal_spic_adaptor->spic_bit_mode;
    uint8_t cpu_type = spic_query_system_clk();
    ...
    spic_data[0] = ((uint32_t)(*((volatile uint32_t*)(0x98000000 + 0x1040 + data_offset))));
    ...
    if (spic_data[0] == 0xFFFFFFFF) {
        ...
        hal_flash_page_program(phal_spic_adaptor, 8, (uint32_t)(0x1040 + data_offset), (uint8_t *)&spic_data[0]);
        do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000100), 0)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Wrn]" "spic_store_calibration_setting: Wr=%x\r\n", spic_data[0]));}while(0);
    } else {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "spic_store_calibration_setting: The flash memory(@0x%x = 0x%x) cannot be programmed, Erase it first!!\r\n", (0x1040 + data_offset), spic_data[0]));}while(0)
                                                         ;
    }
}
# 898 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_store_setting(phal_spic_adaptor_t phal_spic_adaptor, phal_spic_restore_setting_t phal_spic_setting)
{
    uint8_t cpu_type = spic_query_system_clk();
    uint8_t spic_bit_mode = phal_spic_adaptor->spic_bit_mode;
    ...
    phal_spic_setting->recored = 0x871078EF;
}
# 926 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
void spic_recover_setting(phal_spic_adaptor_t phal_spic_adaptor, phal_spic_restore_setting_t phal_spic_setting)
{
    SPIC_Type *spic_dev;
    pspic_init_para_t pspic_init_data = 
# 929 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c" 3 4
                                       ((void *)0)
# 929 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_spic.c"
                                           ;
    uint8_t cpu_type = spic_query_system_clk();
    ...
    hal_syson_spic_dev_ctrl(1);

    spic_pinmux_ctl(phal_spic_adaptor, 1);

    phal_spic_adaptor->spic_dev = ((SPIC_Type*) 0x40020000UL);
    spic_dev = phal_spic_adaptor->spic_dev;
