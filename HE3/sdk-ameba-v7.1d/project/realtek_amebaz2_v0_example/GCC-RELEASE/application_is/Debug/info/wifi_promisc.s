...
.LVL2:
	...
	.loc 1 289 0
	ldr	r2, [r3, #6]!	@ unaligned
	str	r2, [r0, #14]	@ unaligned
...
.LVL40:
	...
	beq	.L42
.LVL41:
	ldrb	r4, [r3, #72]	@ zero_extendqisi2
	cmp	r4, #10
	beq	.L43
.LVL42:
	ldrb	r4, [r3, #96]	@ zero_extendqisi2
	cmp	r4, #10
	beq	.L44
	.loc 1 198 0
	mov	r0, #-1
...
paff_array:
	.space	120
	.section	.rodata.cmd_promisc.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
