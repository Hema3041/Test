...
.Ltext0:
	...
	.section	.text.sw_rtc_tick_handler,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	sw_rtc_tick_handler
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	sw_rtc_tick_handler, %function
sw_rtc_tick_handler:
.LFB561:
	.file 1 "../../../component/common/mbed/targets/hal/rtl8710c/rtc_api.c"
	.loc 1 63 0
	.cfi_startproc
...
.L27:
	...
	.cfi_endproc
.LFE561:
	.size	sw_rtc_tick_handler, .-sw_rtc_tick_handler
...
.L31:
	.word	.LANCHOR5
	.word	sw_rtc_tick_handler
	.word	1000000
	.word	.LANCHOR6
	.cfi_endproc
.LFE562:
	.size	rtc_init, .-rtc_init
	.section	.text.rtc_free,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	rtc_free
	.syntax unified
...
.L35:
	...
	.cfi_endproc
.LFE563:
	.size	rtc_free, .-rtc_free
	.section	.text.rtc_isenabled,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	rtc_isenabled
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	rtc_isenabled, %function
rtc_isenabled:
.LFB564:
	.loc 1 115 0
	.cfi_startproc
...
.L38:
	...
	.cfi_endproc
.LFE564:
	.size	rtc_isenabled, .-rtc_isenabled
	.section	.text.rtc_read,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	rtc_read
	.syntax unified
...
.LFE565:
	...
	.section	.text.rtc_write,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	rtc_write
	.syntax unified
...
.LFE567:
	...
	.section	.text.rtc_disable_alarm,"ax",%progbits
	.align	1
	.p2align 2,,3
	...
	.thumb_func
	.fpu softvfp
	.type	rtc_disable_alarm, %function
rtc_disable_alarm:
.LFB568:
	.loc 1 185 0
	.cfi_startproc
...
.L56:
	...
	.cfi_endproc
.LFE568:
	.size	rtc_disable_alarm, .-rtc_disable_alarm
	.section	.bss.count_down,"aw",%nobits
	.align	2
	.set	.LANCHOR3,. + 0
	.type	count_down, %object
	.size	count_down, 4
count_down:
	.space	4
	.section	.bss.rtc_alarm_handler,"aw",%nobits
	.align	2
	.set	.LANCHOR4,. + 0
	.type	rtc_alarm_handler, %object
	.size	rtc_alarm_handler, 4
rtc_alarm_handler:
	.space	4
	.section	.bss.rtc_timeinfo,"aw",%nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	rtc_timeinfo, %object
	.size	rtc_timeinfo, 36
rtc_timeinfo:
	.space	36
	.section	.bss.sw_rtc,"aw",%nobits
	.align	2
	.set	.LANCHOR5,. + 0
	.type	sw_rtc, %object
	.size	sw_rtc, 92
sw_rtc:
	.space	92
	.section	.bss.sw_rtc_count_en,"aw",%nobits
	.align	2
	.set	.LANCHOR2,. + 0
	.type	sw_rtc_count_en, %object
	.size	sw_rtc_count_en, 4
sw_rtc_count_en:
	.space	4
	.section	.bss.sw_rtc_en,"aw",%nobits
	.align	2
	.set	.LANCHOR6,. + 0
	.type	sw_rtc_en, %object
	.size	sw_rtc_en, 4
sw_rtc_en:
	.space	4
	.section	.rodata.dim,"a",%progbits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	dim, %object
	.size	dim, 12
...
.Letext0:
	...
	.file 47 "../../../component/common/mbed/hal/rtc_api.h"
	.file 48 "../../../component/common/mbed/hal/timer_api.h"
