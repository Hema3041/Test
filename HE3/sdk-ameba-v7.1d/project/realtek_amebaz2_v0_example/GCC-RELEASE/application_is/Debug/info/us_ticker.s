...
.Ltext0:
	...
	.section	.text._us_ticker_irq_handler,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	_us_ticker_irq_handler
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	_us_ticker_irq_handler, %function
_us_ticker_irq_handler:
.LFB559:
	.file 1 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker.c"
	.loc 1 96 0
	.cfi_startproc
...
.L3:
	...
	.cfi_endproc
.LFE559:
	.size	_us_ticker_irq_handler, .-_us_ticker_irq_handler
	.section	.text.us_ticker_init,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	us_ticker_init
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	us_ticker_init, %function
us_ticker_init:
.LFB560:
	.loc 1 102 0
	.cfi_startproc
...
.L10:
	...
	.word	hal_gtimer_stubs
	.word	system_timer
	.word	_us_ticker_irq_handler
	.cfi_endproc
.LFE560:
	.size	us_ticker_init, .-us_ticker_init
	.section	.text.us_ticker_read,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	us_ticker_read
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	us_ticker_read, %function
us_ticker_read:
.LFB561:
	.loc 1 112 0
	.cfi_startproc
...
.LBE24:
	.cfi_endproc
.LFE561:
	.size	us_ticker_read, .-us_ticker_read
	.section	.text.us_ticker_set_interrupt,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	us_ticker_set_interrupt
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	us_ticker_set_interrupt, %function
...
.LBE31:
	.loc 1 125 0
	ldrb	r9, [r2, #36]	@ zero_extendqisi2
.LBB34:
.LBB29:
	.loc 2 630 0
	mov	r8, r0
...
.LBE45:
	.cfi_endproc
.LFE562:
	.size	us_ticker_set_interrupt, .-us_ticker_set_interrupt
	.section	.text.us_ticker_disable_interrupt,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	us_ticker_disable_interrupt
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	us_ticker_disable_interrupt, %function
...
.LFB566:
	...
	@ link register save eliminated.
	.syntax unified
@ 143 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker.c" 1
	nop
@ 0 "" 2
	.thumb
	.syntax unified
	...
	.cfi_endproc
.LFE566:
	.size	us_ticker_disable_interrupt, .-us_ticker_disable_interrupt
	.section	.text.us_ticker_clear_interrupt,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	us_ticker_clear_interrupt
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	us_ticker_clear_interrupt, %function
...
@ 0 "" 2
	...
	.cfi_endproc
.LFE564:
	.size	us_ticker_clear_interrupt, .-us_ticker_clear_interrupt
	.section	.bss.us_ticker_inited,"aw",%nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	us_ticker_inited, %object
	.size	us_ticker_inited, 4
us_ticker_inited:
	.space	4
	.text
.Letext0:
	...
	.file 46 "../../../component/common/mbed/hal/us_ticker_api.h"
...
.LASF1355:
	.ascii	"_us_ticker_irq_handler\000"
.LASF447:
	.ascii	"raw_tfr\000"
.LASF1146:
