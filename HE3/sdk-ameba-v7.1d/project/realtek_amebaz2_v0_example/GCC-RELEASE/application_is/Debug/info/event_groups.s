...
.LBE155:
.LBB160:
	.loc 1 307 0 is_stmt 1 discriminator 2
	bl	xTaskGetSchedulerState
.LVL89:
	cmp	r0, #1
	beq	.L76
...
.LVL128:
	cmp	r0, #1
	beq	.L96
	.loc 1 310 0 is_stmt 0 discriminator 10
	mov	r0, r4
	bl	pcTaskGetName
.LVL129:
	mov	r1, r0
...
.LVL156:
	ldr	r0, .L151
.LVL157:
	b	xTimerPendFunctionCallFromISR
.LVL158:
.L152:
	.align	2
.L151:
...
.LBE218:
.LBE217:
	.loc 1 187 0 discriminator 8
	bl	xTaskGetSchedulerState
.LVL250:
	cmp	r0, #1
	beq	.L214
	.loc 1 187 0 is_stmt 0 discriminator 10
	mov	r0, r4
	bl	pcTaskGetName
.LVL251:
	mov	r1, r0
...
.LFE158:
	...
	.section	.rodata.vEventGroupClearBitsCallback.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"ISR\000"
.LC1:
...
.LC8:
	...
	.ascii	"\012\000"
	.section	.rodata.vEventGroupSetBitsCallback.str1.4,"aMS",%progbits,1
	.align	2
.LC4:
