# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
# 29 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_gdma.h" 1
# 31 "../../../component/soc/realtek/8710c/fwlib/include/hal_gdma.h"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/include/hal_gdma.h" 2
...
# 30 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c" 2
...
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c" 2
...
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c" 2
...
# 33 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c" 2

extern hal_status_t hal_xip_get_phy_addr (uint32_t vaddr, uint32_t *ppaddr, uint32_t *pis_enc);
# 44 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
const hal_gdma_chnl_t gdma_chnl_option[] = {
        {0,0},
        {0,1},
        {0xff,0}
};
# 69 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
BOOL hal_gdma_memcpy_init(phal_gdma_adaptor_t phal_gdma_adaptor)
{
    rt_memset((void *)phal_gdma_adaptor, 0, sizeof(hal_gdma_adaptor_t));
    ...
    if (hal_gdma_chnl_alloc(phal_gdma_adaptor) != (0x00)) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000002), 1)) (stdio_printf_stubs.rt_printfl("\r" "[GDMA Err]" "Cannot Allocate Channel !\n"));}while(0);
        return 0;
    } else {
...
# 100 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
void hal_gdma_memcpy_deinit(phal_gdma_adaptor_t phal_gdma_adaptor)
{

    hal_gdma_chnl_free(phal_gdma_adaptor);
}
# 117 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
hal_status_t hal_gdma_memcpy(phal_gdma_adaptor_t phal_gdma_adaptor, void *pdest, void *psrc, uint32_t len)
{
    uint32_t is_encry;
    uint32_t *phy_src;
    ...
    if (phal_gdma_adaptor->dcache_clean_by_addr != 
# 135 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c" 3 4
                                                  ((void *)0)
# 135 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
                                                      ) {
...
# 212 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
hal_status_t hal_gdma_chnl_alloc (phal_gdma_adaptor_t phal_gdma_adaptor)
{
    ...
    if (phal_gdma_adaptor->have_chnl == 0) {
        ...
        while (pgdma_chnl->gdma_indx <= 0) {
            if (hal_gdma_chnl_register(pgdma_chnl->gdma_indx, pgdma_chnl->gdma_chnl) == (0x00)) {
                ...
                do { if (__builtin_expect (((*(utility_stubs.config_debug_info)) & 0x00000002), 0)) (stdio_printf_stubs.rt_printfl("\r" "[GDMA Inf]" "GDMA Index = %d, Channel = %d\n", phal_gdma_adaptor->gdma_index,phal_gdma_adaptor->ch_num));}while(0)
                                                                            ;
...
# 252 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_gdma.c"
void hal_gdma_chnl_free (phal_gdma_adaptor_t phal_gdma_adaptor)
{
