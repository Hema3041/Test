# 1 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
# 16 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
# 1 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/lib/gcc/arm-none-eabi/6.5.0/include/stddef.h" 1 3 4
# 17 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 2
# 1 "../../../component/common/mbed/hal/us_ticker_api.h" 1
# 19 "../../../component/common/mbed/hal/us_ticker_api.h"
...
# 20 "../../../component/common/mbed/hal/us_ticker_api.h" 2
...
# 18 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 2
...
# 19 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 2
...
void us_ticker_irq_handler(void)
{
    ...
    while (1) {
        if (head == 
# 36 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
                   ((void *)0)
# 36 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                       ) {
        ...
        if ((int)(head->timestamp - us_ticker_read()) <= 0) {
            ...
            head = head->next;
            if (event_handler != 
# 48 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
                                ((void *)0)
# 48 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                                    ) {
                event_handler(p->id);
            }
...
void us_ticker_insert_event(ticker_event_t *obj, timestamp_t timestamp, uint32_t id)
{
    ...
    ticker_event_t *prev = 
# 74 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
                          ((void *)0)
# 74 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                              , *p = head;

    while (p != 
# 76 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
               ((void *)0)
# 76 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                   ) {
    ...
    if (prev == 
# 86 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
               ((void *)0)
# 86 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                   ) {
        head = obj;
...
void us_ticker_remove_event(ticker_event_t *obj)
{
    ...
    if (head == obj) {
        ...
        head = obj->next;
        if (head == 
# 106 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
                   ((void *)0)
# 106 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                       ) {
            us_ticker_disable_interrupt();
        } else {
            us_ticker_set_interrupt(head->timestamp);
        ...
        while (p != 
# 115 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c" 3 4
                   ((void *)0)
# 115 "../../../component/common/mbed/targets/hal/rtl8710c/us_ticker_api.c"
                       ) {
            if (p->next == obj) {
                p->next = obj->next;
                break;
