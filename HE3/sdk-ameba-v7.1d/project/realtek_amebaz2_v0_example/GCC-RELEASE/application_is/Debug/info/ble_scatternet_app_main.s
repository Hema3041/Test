...
.LFB159:
	...
	strb	r5, [sp, #10]
	.loc 1 167 0
	str	r5, [sp, #67]	@ unaligned
	str	r5, [sp, #71]	@ unaligned
	str	r5, [sp, #75]	@ unaligned
	str	r5, [sp, #79]	@ unaligned
	str	r5, [sp, #83]	@ unaligned
	strb	r5, [sp, #87]
	.loc 1 174 0
	strh	r5, [sp, #44]	@ movhi
	.loc 1 175 0
...
adv_data:
	...
	.byte	69
	.byte	84
	.section	.rodata.ble_scatternet_app_deinit.str1.4,"aMS",%progbits,1
	.align	2
.LC2:
...
.LC3:
	...
	.section	.rodata.ble_scatternet_app_init.str1.4,"aMS",%progbits,1
	.align	2
.LC1:
...
.Letext0:
	...
	.file 22 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/lib/gcc/arm-none-eabi/6.5.0/include/stdarg.h"
	.file 23 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/arm-none-eabi/include/stdio.h"
	...
	.file 43 "../../../component/common/bluetooth/realtek/sdk/inc/bluetooth/profile/client/gcs_client.h"
	.file 44 "../../../component/common/bluetooth/realtek/sdk/inc/bluetooth/profile/server/simple_ble_service.h"
	.file 45 "../../../component/common/bluetooth/realtek/sdk/inc/bluetooth/profile/server/bas.h"
	.file 46 "../../../component/common/bluetooth/realtek/sdk/inc/platform/trace_app.h"
	.file 47 "../../../component/common/api/wifi/wifi_conf.h"
	.file 48 "../../../component/os/freertos/freertos_v10.0.1/Source/include/task.h"
	.file 49 "../../../component/common/bluetooth/realtek/sdk/board/amebaz2/src/rtk_coex.h"
