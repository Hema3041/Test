# 1 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c"
# 29 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c"
...
# 30 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c" 2





# 1 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/include/mpu_config.h" 1
# 33 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/include/mpu_config.h"
...
# 34 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/include/mpu_config.h" 2
# 36 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c" 2


void mpu_init (void)
{
    if (((0 << 7) | (0 << 6) | (0 << 5) | (0 << 4) | (0 << 3) | (0 << 2) | (1 << 1) | (0)) == 0) {
    ...
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR0 = (((((0x04) << 4) | (0x04))) << 0U) |
                 (((((0x02) << 4) | (0x02))) << 8U) |
                 (((((0x06) << 4) | (0x06))) << 16U) |
                 (((((0x0A) << 4) | (0x0A))) << 24U);

    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR1 = (((((0x0E) << 4) | (0x0E))) << 0U) |
                 (((((0x07) << 4) | (0x07))) << 8U) |
                 (((((0x0F) << 4) | (0x0F))) << 16U) |
                 (((((0<<4)|(0<<2)))) << 24U);
...
# 71 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c"
    do { if (__builtin_expect (((*(utility_stubs.config_debug_info)) & 0x40000000), 1)) (stdio_printf_stubs.rt_printfl("\r" "[MISC Inf]" "Set MPU 1: 0x%x ~ 0x%x: \r\n", (0x98000000), (0x98001FFF)));}while(0);
    do { if (__builtin_expect (((*(utility_stubs.config_debug_info)) & 0x40000000), 1)) (stdio_printf_stubs.rt_printfl("\r" "[MISC Inf]" "Shareable=0x%x  AccessPermision=0x%x XNever=0x%x AttrIdx=%lu\r\n", MPU_OUT_SHAREABLE, MPU_UN_PRIV_RW, MPU_EXEC_NEVER, 0));}while(0);
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RBAR_A1 = ((0x98000000) & (0x7FFFFFFUL << 5U)) | MPU_OUT_SHAREABLE | MPU_UN_PRIV_RW | MPU_EXEC_NEVER;
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RLAR_A1 = ((0x98001FFF) & (0x7FFFFFFUL << 5U)) |
                   ((0 << 1U) & (0x7UL << 1U)) | MPU_REGION_ENABLE;
# 92 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/source/ram/mpu_config.c"
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->CTRL |= (1 << 2U) | (0 << 1U);

    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->CTRL |= (1 << 0U);
...
void mpu_set_mem_attr(uint8_t attr_idx, uint8_t mem_attr)
{
    ...
    if (attr_idx < 4) {
        ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR0 &= ~mair_mask;
        ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR0 |= mem_attr << bit_offset;
    } else {
        ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR1 &= ~mair_mask;
        ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->MAIR1 |= mem_attr << bit_offset;
    }
}
...
void mpu_region_cfg(uint8_t region_num, mpu_region_config_t *pmpu_cfg)
{
    ...
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RNR = region_num;
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RBAR = (pmpu_cfg->region_base & (0x7FFFFFFUL << 5U)) | pmpu_cfg->sh | pmpu_cfg->ap | pmpu_cfg->xn;
    ((MPU_Type *) ((0xE000E000UL) + 0x0D90UL) )->RLAR = (pmpu_cfg->region_limit & (0x7FFFFFFUL << 5U)) |
                ((pmpu_cfg->attr_idx << 1U) & (0x7UL << 1U)) | MPU_REGION_ENABLE;
