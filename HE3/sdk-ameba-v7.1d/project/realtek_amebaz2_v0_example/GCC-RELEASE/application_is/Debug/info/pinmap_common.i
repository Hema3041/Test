# 1 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c"
# 29 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c"
...
# 30 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c" 2
...
# 31 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c" 2
...
# 32 "../../../component/common/mbed/targets/hal/rtl8710c/pinmap_common.c" 2
...
uint32_t pinmap_merge(uint32_t a, uint32_t b)
{
    ...
    do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x40000000), 1)) (stdio_printf_stubs.rt_printfl("\r" "[MISC Err]" "pinmap_merge: pinmap mis-match\n"));}while(0);
    return (uint32_t)NC;
}
...
uint32_t pinmap_peripheral(PinName pin, const PinMap *map)
{
    ...
    if ((uint32_t)NC == peripheral) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x40000000), 1)) (stdio_printf_stubs.rt_printfl("\r" "[MISC Err]" "pinmap_peripheral: pinmap not found for peripheral\n"));}while(0);
    }
    return peripheral;
}
