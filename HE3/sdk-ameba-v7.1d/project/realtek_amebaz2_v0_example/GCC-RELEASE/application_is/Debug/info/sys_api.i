# 1 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
# 18 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
...
# 19 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
# 1 "../../../component/common/mbed/hal_ext/sys_api.h" 1
# 24 "../../../component/common/mbed/hal_ext/sys_api.h"
...
# 25 "../../../component/common/mbed/hal_ext/sys_api.h" 2
...
# 20 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
# 21 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
# 22 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
# 23 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
void hal_misc_wdt_reg_irq (irq_handler_t handler, void *arg);
# 24 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
# 25 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 2
...
# 44 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
...
# 70 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
void sys_clear_ota_signature(void)
{
 flash_t flash;
 uint32_t targetFWaddr;
 uint8_t *pbuf = 
# 74 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                ((void *)0)
# 74 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                    ;
 ...
 flash_stream_read(&flash, targetFWaddr, 0x1000, pbuf);

 pbuf[0] = ~(pbuf[0]);
 flash_erase_sector(&flash, targetFWaddr);
 flash_burst_write(&flash, targetFWaddr, 0x1000, pbuf);
...
void sys_recover_ota_signature(void)
{
 ...
 uint8_t *pbuf = 
# 116 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                ((void *)0)
# 116 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                    ;
 uint32_t fw1_sn;
 uint32_t fw2_sn;
...
int32_t sys_update_ota_set_boot_fw_idx(uint32_t boot_idx)
{
 ...
 uint32_t targetFWaddr;
 uint8_t *pbuf = 
# 188 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                ((void *)0)
# 188 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                    ;
 uint8_t cur_idx;
 uint32_t currentFWaddr;
 uint32_t fw1_sn;
 ...
 rtw_enter_critical(
# 209 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                   ((void *)0)
# 209 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                       , 
# 209 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                         ((void *)0)
# 209 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
 ...
 device_mutex_lock(RT_DEV_LOCK_FLASH);
 flash_stream_read(&flash, currentFWaddr, 0x1000, pbuf);

 pbuf[0] = ~(pbuf[0]);
 flash_erase_sector(&flash, currentFWaddr);
 flash_burst_write(&flash, currentFWaddr, 0x1000, pbuf);
 device_mutex_unlock(RT_DEV_LOCK_FLASH);
 rtw_exit_critical(
# 217 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                  ((void *)0)
# 217 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                      , 
# 217 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                        ((void *)0)
# 217 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                            );
 rtw_mfree((uint8_t *)pbuf, 0);
 return 0;
}
...
uint32_t sys_update_ota_prepare_addr(void)
{
 ...
 __wrap_printf("\n\r[%s] currentFWaddr %08X\n\r", __FUNCTION__, currentFWaddr);
 return NewFWAddr;
}

uint32_t hoags_get_current_img_addr(void)
{
 uint32_t targetFWaddr;
 uint32_t currentFWaddr;
 uint32_t fw1_sn;
...
# 254 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c" 3 4
                      ((void *)0)
# 254 "../../../component/common/mbed/targets/hal/rtl8710c/sys_api.c"
                          , 0);
}
...
void sys_log_uart_on(void)
{
 log_uart_port_init((16), (15), ((uint32_t)115200));
}
