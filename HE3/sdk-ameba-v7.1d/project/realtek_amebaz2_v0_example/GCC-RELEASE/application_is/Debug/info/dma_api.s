...
.Ltext0:
	...
	.section	.text.dma_memcpy_init,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	dma_memcpy_init
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	dma_memcpy_init, %function
dma_memcpy_init:
.LFB559:
	.file 1 "../../../component/common/mbed/targets/hal/rtl8710c/dma_api.c"
	.loc 1 43 0
	.cfi_startproc
...
.LBE7:
	.cfi_endproc
.LFE559:
	.size	dma_memcpy_init, .-dma_memcpy_init
	.section	.text.dma_memcpy_deinit,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	dma_memcpy_deinit
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	dma_memcpy_deinit, %function
dma_memcpy_deinit:
.LFB560:
	.loc 1 58 0
	.cfi_startproc
...
.LVL5:
	.loc 1 60 0
	b	hal_gdma_memcpy_deinit
.LVL6:
	.cfi_endproc
.LFE560:
	.size	dma_memcpy_deinit, .-dma_memcpy_deinit
	.section	.text.dma_memcpy,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	dma_memcpy
	.syntax unified
...
.Letext0:
	...
	.file 47 "../../../component/common/mbed/hal_ext/dma_api.h"
...
.LASF569:
	.ascii	"log_buf\000"
.LASF1355:
	.ascii	"gdma_cb_phal_gdma_adaptor\000"
.LASF1128:
