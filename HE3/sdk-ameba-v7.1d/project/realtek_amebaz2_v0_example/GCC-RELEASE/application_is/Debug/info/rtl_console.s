...
uart_put_char:
.LFB578:
	.file 1 "../../../component/soc/realtek/8710c/misc/driver/rtl_console.c"
	.loc 1 57 0
	.cfi_startproc
...
.LBB48:
.LBB49:
	.file 2 "../../../component/soc/realtek/8710c/app/stdio_port/stdio_port_func.h"
	.loc 2 90 0
	ldr	r3, .L2
	ldr	r3, [r3, #8]
	bx	r3
...
.LFE584:
	...
	.comm	cmd_history,400,4
	.section	.bss.buf_count.21564,"aw",%nobits
	.align	1
	.set	.LANCHOR5,. + 0
	.type	buf_count.21564, %object
	.size	buf_count.21564, 2
buf_count.21564:
	.space	2
...
cmd_history_count:
	.space	4
	.section	.bss.cmd_history_index.21566,"aw",%nobits
	.set	.LANCHOR2,. + 0
	.type	cmd_history_index.21566, %object
	.size	cmd_history_index.21566, 1
cmd_history_index.21566:
	.space	1
	.section	.bss.combo_key.21563,"aw",%nobits
	.set	.LANCHOR1,. + 0
	.type	combo_key.21563, %object
	.size	combo_key.21563, 1
combo_key.21563:
	.space	1
	.section	.bss.key_enter.21565,"aw",%nobits
	.set	.LANCHOR0,. + 0
	.type	key_enter.21565, %object
	.size	key_enter.21565, 1
key_enter.21565:
	.space	1
	.section	.bss.temp_buf.21562,"aw",%nobits
	.align	2
	.set	.LANCHOR4,. + 0
	.type	temp_buf.21562, %object
	.size	temp_buf.21562, 100
temp_buf.21562:
	.space	100
	.section	.rodata.uart_irq.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
...
.Letext0:
	...
	.file 49 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/arm-none-eabi/include/stdlib.h"
	.file 50 "../../../component/common/api/at_cmd/log_service.h"
	.file 51 "../../../component/os/freertos/freertos_service.h"
	.file 52 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/arm-none-eabi/include/string.h"
