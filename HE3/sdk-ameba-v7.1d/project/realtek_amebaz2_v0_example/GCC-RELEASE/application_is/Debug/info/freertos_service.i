# 1 "../../../component/os/freertos/freertos_service.c"
...
# 3 "../../../component/os/freertos/freertos_service.c" 2
...
# 4 "../../../component/os/freertos/freertos_service.c" 2
...
# 5 "../../../component/os/freertos/freertos_service.c" 2
...
# 6 "../../../component/os/freertos/freertos_service.c" 2

# 1 "../../../component/os/os_dep/include/osdep_service.h" 1
# 75 "../../../component/os/os_dep/include/osdep_service.h"
...
# 76 "../../../component/os/os_dep/include/osdep_service.h" 2
...
# 8 "../../../component/os/freertos/freertos_service.c" 2

# 1 "../../../component/os/freertos/freertos_pmu.h" 1
# 81 "../../../component/os/freertos/freertos_pmu.h"
typedef enum {
 PMU_OS =0,
 PMU_WLAN_DEVICE =1,
...
# 110 "../../../component/os/freertos/freertos_pmu.h"
...
# 140 "../../../component/os/freertos/freertos_pmu.h"
...
# 158 "../../../component/os/freertos/freertos_pmu.h"
...
# 10 "../../../component/os/freertos/freertos_service.c" 2
...
# 14 "../../../component/os/freertos/freertos_service.c" 2
# 1 "../../../component/soc/realtek/8710c/misc/os/rtl8710c_freertos_pmu.h" 1
# 9 "../../../component/soc/realtek/8710c/misc/os/rtl8710c_freertos_pmu.h"
typedef struct
{
 uint32_t nDeviceId;
...
# 33 "../../../component/soc/realtek/8710c/misc/os/rtl8710c_freertos_pmu.h"
...
# 15 "../../../component/os/freertos/freertos_service.c" 2
# 23 "../../../component/os/freertos/freertos_service.c"
...
uint8_t* _freertos_zmalloc(uint32_t sz)
{
 ...
 if (pbuf != 
# 89 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 89 "../../../component/os/freertos/freertos_service.c"
                )
  memset(pbuf, 0, sz);
...
{
 if(*sema != 
# 129 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 129 "../../../component/os/freertos/freertos_service.c"
                )
  vQueueDelete( ( QueueHandle_t ) ( *sema ) );

 *sema = 
# 132 "../../../component/os/freertos/freertos_service.c" 3 4
        ((void *)0)
# 132 "../../../component/os/freertos/freertos_service.c"
            ;
}

static void _freertos_up_sema(_sema *sema)
{
 xQueueGenericSend( ( QueueHandle_t ) ( *sema ), 
# 137 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 137 "../../../component/os/freertos/freertos_service.c"
...
static void _freertos_up_sema_from_isr(_sema *sema)
{
 ...
 xQueueGiveFromISR( ( QueueHandle_t ) ( *sema ), ( &taskWoken ) );
...
static uint32_t _freertos_down_sema(_sema *sema, uint32_t timeout)
{
 ...
 if(_freertos_get_scheduler_state() == 2 && timeout != 0)
  return ( ( BaseType_t ) 1 );

 if(xQueueSemaphoreTake( ( *sema ), ( timeout ) ) != ( ( BaseType_t ) 1 )) {
  return ( ( BaseType_t ) 0 );
 }
...
{
 if(*pmutex != 
# 172 "../../../component/os/freertos/freertos_service.c" 3 4
              ((void *)0)
# 172 "../../../component/os/freertos/freertos_service.c"
                  )
  vQueueDelete( ( QueueHandle_t ) ( *pmutex ) );

 *pmutex = 
# 175 "../../../component/os/freertos/freertos_service.c" 3 4
          ((void *)0)
# 175 "../../../component/os/freertos/freertos_service.c"
              ;
}
...
static void _freertos_mutex_get(_mutex *pmutex)
{
 ...
 if(_freertos_get_scheduler_state() == 2)
  return;

 if(__in_interrupt()){
  if(xQueueReceiveFromISR( ( QueueHandle_t ) ( *pmutex ), 
# 194 "../../../component/os/freertos/freertos_service.c" 3 4
    ((void *)0)
# 194 "../../../component/os/freertos/freertos_service.c"
    , ( 
# 194 "../../../component/os/freertos/freertos_service.c" 3 4
    ((void *)0) 
# 194 "../../../component/os/freertos/freertos_service.c"
    ) ) != ( ( BaseType_t ) 1 ))
   __wrap_printf("[%s] %s(%p) from ISR <<< FAIL >>> \n", pcTaskGetName(
# 195 "../../../component/os/freertos/freertos_service.c" 3 4
                                                                   ((void *)0)
# 195 "../../../component/os/freertos/freertos_service.c"
                                                                       ), __FUNCTION__, pmutex);
 }else{
  while(xQueueSemaphoreTake( ( *pmutex ), ( 60 * 1000 / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ) ) != ( ( BaseType_t ) 1 ))
   __wrap_printf("[%s] %s(%p) failed, retry\n", pcTaskGetName(
# 198 "../../../component/os/freertos/freertos_service.c" 3 4
                                                          ((void *)0)
# 198 "../../../component/os/freertos/freertos_service.c"
                                                              ), __FUNCTION__, pmutex);
 }
}
...
static int _freertos_mutex_get_timeout(_mutex *pmutex, uint32_t timeout_ms)
{
 ...
 if(_freertos_get_scheduler_state() == 2 && timeout_ms != 0)
  return 0;

 if(__in_interrupt()){
  if(xQueueReceiveFromISR( ( QueueHandle_t ) ( *pmutex ), 
# 209 "../../../component/os/freertos/freertos_service.c" 3 4
    ((void *)0)
# 209 "../../../component/os/freertos/freertos_service.c"
    , ( 
# 209 "../../../component/os/freertos/freertos_service.c" 3 4
    ((void *)0) 
# 209 "../../../component/os/freertos/freertos_service.c"
   ...
   __wrap_printf("[%s] %s(%p) from ISR <<< FAIL >>> \n", pcTaskGetName(
# 210 "../../../component/os/freertos/freertos_service.c" 3 4
                                                                   ((void *)0)
# 210 "../../../component/os/freertos/freertos_service.c"
                                                                       ), __FUNCTION__, pmutex);
   return -1;
  }
 }else{
  if(xQueueSemaphoreTake( ( *pmutex ), ( timeout_ms / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ) ) != ( ( BaseType_t ) 1 )){
   __wrap_printf("[%s] %s(%p) failed, retry\n", pcTaskGetName(
# 215 "../../../component/os/freertos/freertos_service.c" 3 4
                                                          ((void *)0)
# 215 "../../../component/os/freertos/freertos_service.c"
                                                              ), __FUNCTION__, pmutex);
   return -1;
  }
 }
...
{
 if(__in_interrupt()){
  xQueueGiveFromISR( ( QueueHandle_t ) ( *pmutex ), ( 
# 225 "../../../component/os/freertos/freertos_service.c" 3 4
 ((void *)0) 
# 225 "../../../component/os/freertos/freertos_service.c"
 ) );
 }else{
  xQueueGenericSend( ( QueueHandle_t ) ( *pmutex ), 
# 227 "../../../component/os/freertos/freertos_service.c" 3 4
 ((void *)0)
# 227 "../../../component/os/freertos/freertos_service.c"
 , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
 }
}
...
# 291 "../../../component/os/freertos/freertos_service.c" 3 4
                                                             ((void *)0)
# 291 "../../../component/os/freertos/freertos_service.c"
                                                                 ), __FUNCTION__, pmutex);
...
static void _freertos_exit_critical_mutex(_mutex *pmutex, _irqL *pirqL)
{
 ...
 xQueueGenericSend( ( QueueHandle_t ) ( *pmutex ), 
# 301 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 301 "../../../component/os/freertos/freertos_service.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}


# 1 "../../../component/common/mbed/hal/timer_api.h" 1
# 28 "../../../component/common/mbed/hal/timer_api.h"
...
# 29 "../../../component/common/mbed/hal/timer_api.h" 2
...
# 306 "../../../component/os/freertos/freertos_service.c" 2

# 1 "../../../component/common/mbed/hal/us_ticker_api.h" 1
# 25 "../../../component/common/mbed/hal/us_ticker_api.h"
...
# 308 "../../../component/os/freertos/freertos_service.c" 2
...
static void _freertos_spinlock_free(_lock *plock)
{
 ...
 if(*plock != 
# 354 "../../../component/os/freertos/freertos_service.c" 3 4
             ((void *)0)
# 354 "../../../component/os/freertos/freertos_service.c"
                 )
  vQueueDelete( ( QueueHandle_t ) ( *plock ) );

 *plock = 
# 357 "../../../component/os/freertos/freertos_service.c" 3 4
         ((void *)0)
# 357 "../../../component/os/freertos/freertos_service.c"
             ;
...
static void _freertos_spinlock(_lock *plock)
{
 ...
 while(xQueueSemaphoreTake( ( *plock ), ( 60 * 1000 / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ) ) != ( ( BaseType_t ) 1 ))
  __wrap_printf("[%s] %s(%p) failed, retry\n", pcTaskGetName(
# 369 "../../../component/os/freertos/freertos_service.c" 3 4
                                                         ((void *)0)
# 369 "../../../component/os/freertos/freertos_service.c"
                                                             ), __FUNCTION__, plock);
...
static void _freertos_spinunlock(_lock *plock)
{
 ...
 xQueueGenericSend( ( QueueHandle_t ) ( *plock ), 
# 380 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 380 "../../../component/os/freertos/freertos_service.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
static void _freertos_spinlock_irqsave(_lock *plock, _irqL *irqL)
{
 ...
 while(xQueueSemaphoreTake( ( *plock ), ( 60 * 1000 / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ) ) != ( ( BaseType_t ) 1 ))
  __wrap_printf("[%s] %s(%p) failed, retry\n", pcTaskGetName(
# 392 "../../../component/os/freertos/freertos_service.c" 3 4
                                                         ((void *)0)
# 392 "../../../component/os/freertos/freertos_service.c"
                                                             ), __FUNCTION__, plock);
...
static void _freertos_spinunlock_irqsave(_lock *plock, _irqL *irqL)
{
 ...
 xQueueGenericSend( ( QueueHandle_t ) ( *plock ), 
# 401 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 401 "../../../component/os/freertos/freertos_service.c"
, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
static int _freertos_init_xqueue( _xqueue* queue, const char* name, uint32_t message_size, uint32_t number_of_messages )
{
 ...
 ( void ) name;
    ...
    if ( ( *queue = xQueueGenericCreate( ( number_of_messages ), ( message_size ), ( ( ( uint8_t ) 0U ) ) ) ) == 
# 411 "../../../component/os/freertos/freertos_service.c" 3 4
                                                                         ((void *)0) 
# 411 "../../../component/os/freertos/freertos_service.c"
                                                                              )
    {
        return -1;
    }
...
static int _freertos_pop_from_xqueue( _xqueue* queue, void* message, uint32_t timeout_ms )
{
 if(timeout_ms == 0xFFFFFFFF) {
  ...
  timeout_ms = rtw_ms_to_systime(timeout_ms);
    ...
    if ( xQueueReceive( *queue, message, timeout_ms ) != ( ( ( BaseType_t ) 1 ) ) )
    {
        return -1;
    }
...
static int _freertos_peek_from_xqueue( _xqueue* queue, void* message, uint32_t timeout_ms )
{
 if(timeout_ms == 0xFFFFFFFF) {
  ...
  timeout_ms = rtw_ms_to_systime(timeout_ms);
    ...
    if ( xQueuePeek( *queue, message, timeout_ms ) != ( ( ( BaseType_t ) 1 ) ) )
    {
        return -1;
    }
...
{
# 515 "../../../component/os/freertos/freertos_service.c"
 if (pmu_yield_os_check()) {
  vTaskDelay(ms / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
 } else {
  do {hal_delay_us((ms)*1000);} while (0);
 }
...
{
# 552 "../../../component/os/freertos/freertos_service.c"
 if (pmu_yield_os_check()) {
  vTaskDelay(ms / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
 } else {
  do {hal_delay_us((ms)*1000);} while (0);
...
# 702 "../../../component/os/freertos/freertos_service.c"
...
static int _freertos_get_random_bytes(void *buf, uint32_t len)
{
 ...
 return 0;
# 738 "../../../component/os/freertos/freertos_service.c"
}
...
# 748 "../../../component/os/freertos/freertos_service.c" 3 4
                          ((void *)0)
# 748 "../../../component/os/freertos/freertos_service.c"
                              ;
 void *task_ctx = 
# 749 "../../../component/os/freertos/freertos_service.c" 3 4
                 ((void *)0)
# 749 "../../../component/os/freertos/freertos_service.c"
                     ;
 int ret = 0;
 ...
 priority += ( ( UBaseType_t ) 0U );
# 790 "../../../component/os/freertos/freertos_service.c"
 {
  ret = xTaskCreate(
    task_func,
    (const char *)name,
 ...
 if(ret != ( ( ( BaseType_t ) 1 ) )){
  __wrap_printf("Create Task \"%s\" Failed! ret=%d\n", ptask->task_name, ret);
 }
...
{
 if (!ptask->task){
  __wrap_printf("_freertos_delete_task(): ptask is NULL!\n");
  return;
 }
...
static void _freertos_thread_exit(void)
{
 ;
 vTaskDelete(
# 852 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 852 "../../../component/os/freertos/freertos_service.c"
                );
}
...
uint32_t _freertos_timerDelete( _timerHandle xTimer,
          osdepTickType xBlockTime )
{
 return (uint32_t)xTimerGenericCommand( ( xTimer ), ( ( BaseType_t ) 5 ), 0U, 
# 870 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 870 "../../../component/os/freertos/freertos_service.c"
            , ( xBlockTime ) );
}
...
uint32_t _freertos_timerStop( _timerHandle xTimer,
          osdepTickType xBlockTime )
{
 return (uint32_t)xTimerGenericCommand( ( xTimer ), ( ( BaseType_t ) 3 ), 0U, 
# 881 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 881 "../../../component/os/freertos/freertos_service.c"
            , ( xBlockTime ) );
}
          ...
          osdepTickType xBlockTime )
{
 if(xNewPeriod == 0)
  xNewPeriod += 1;
 return (uint32_t)xTimerGenericCommand( ( xTimer ), ( ( BaseType_t ) 4 ), ( xNewPeriod ), 
# 890 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 890 "../../../component/os/freertos/freertos_service.c"
            , ( xBlockTime ) );
}
...
uint32_t _freertos_timerStart( _timerHandle xTimer,
          osdepTickType xBlockTime )
{
 return (uint32_t)xTimerGenericCommand( ( xTimer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 
# 900 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 900 "../../../component/os/freertos/freertos_service.c"
            , ( xBlockTime ) );
}
...
uint32_t _freertos_timerReset( _timerHandle xTimer,
          osdepTickType xBlockTime )
{
 return (uint32_t)xTimerGenericCommand( ( xTimer ), ( ( BaseType_t ) 2 ), ( xTaskGetTickCount() ), 
# 933 "../../../component/os/freertos/freertos_service.c" 3 4
            ((void *)0)
# 933 "../../../component/os/freertos/freertos_service.c"
            , ( xBlockTime ) );
}

void _freertos_acquire_wakelock(void)
{
# 952 "../../../component/os/freertos/freertos_service.c"
}

void _freertos_release_wakelock(void)
{
# 971 "../../../component/os/freertos/freertos_service.c"
}
...
# 1037 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 1037 "../../../component/os/freertos/freertos_service.c"
    ,
 
# 1038 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 1038 "../../../component/os/freertos/freertos_service.c"
    ,
...
# 1082 "../../../component/os/freertos/freertos_service.c" 3 4
((void *)0)
# 1082 "../../../component/os/freertos/freertos_service.c"
    ,
