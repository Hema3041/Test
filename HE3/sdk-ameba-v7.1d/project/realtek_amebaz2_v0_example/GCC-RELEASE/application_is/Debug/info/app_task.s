...
.Ltext0:
	...
	.section	.text.app_main_task,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	app_main_task
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	app_main_task, %function
app_main_task:
.LFB166:
	.file 1 "../../../component/common/bluetooth/realtek/sdk/example/ble_peripheral/app_task.c"
	.loc 1 66 0
	.cfi_startproc
...
.LBE2:
	.cfi_endproc
.LFE166:
	.size	app_main_task, .-app_main_task
	.section	.text.app_task_init,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	app_task_init
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
...
.LFE167:
	...
	.section	.text.app_task_deinit,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	app_task_deinit
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	app_task_deinit, %function
app_task_deinit:
.LFB168:
	.loc 1 111 0
	.cfi_startproc
...
.L35:
	...
	.cfi_endproc
.LFE168:
	.size	app_task_deinit, .-app_task_deinit
	.global	io_queue_handle
	.global	evt_queue_handle
	.global	app_task_handle
...
io_queue_handle:
	...
	.size	__func__.8671, 14
__func__.8671:
	.ascii	"app_main_task\000"
	.section	.rodata.__func__.8680,"a",%progbits
	.align	2
	.set	.LANCHOR4,. + 0
	.type	__func__.8680, %object
	.size	__func__.8680, 16
__func__.8680:
...
.Letext0:
	...
	.file 23 "../../../component/common/bluetooth/realtek/sdk/example/ble_peripheral/peripheral_app.h"
	...
	.file 28 "../../../component/common/bluetooth/realtek/sdk/example/ble_peripheral/app_task.h"
...
.LASF232:
	...
	.ascii	"mple/ble_peripheral/app_task.c\000"
.LASF110:
