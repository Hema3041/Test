# 1 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
# 29 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
...
# 39 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/lib/gcc/arm-none-eabi/6.5.0/include/arm_cmse.h" 2 3 4
...
# 30 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 2
...
# 31 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 2
# 1 "../../../component/soc/realtek/8710c/app/shell/shell.h" 1
# 38 "../../../component/soc/realtek/8710c/app/shell/shell.h"
# 1 "/cygdrive/d/PUYA/HE3/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/cygwin/newlib/lib/gcc/arm-none-eabi/6.5.0/include/stddef.h" 1 3 4
# 39 "../../../component/soc/realtek/8710c/app/shell/shell.h" 2
# 87 "../../../component/soc/realtek/8710c/app/shell/shell.h"
enum shell_ctrl_key_ascii_e {
    SHELL_ASCII_NUL = 0x00,
    SHELL_ASCII_BEL = 0x07,
    SHELL_ASCII_BS = 0x08,
    SHELL_ASCII_HT = 0x09,
    SHELL_ASCII_LF = 0x0A,
    SHELL_ASCII_CR = 0x0D,
    SHELL_ASCII_ESC = 0x1B,
    SHELL_ASCII_US = 0x1F,
    SHELL_ASCII_SP = 0x20,
    SHELL_ASCII_DEL = 0x7F
};
# 118 "../../../component/soc/realtek/8710c/app/shell/shell.h"
...
# 119 "../../../component/soc/realtek/8710c/app/shell/shell.h" 2
# 131 "../../../component/soc/realtek/8710c/app/shell/shell.h"
...
# 166 "../../../component/soc/realtek/8710c/app/shell/shell.h"
...
typedef struct shell_command {
    ...
    shell_reader_t shell_reader;
    shell_writer_t shell_writer;
    void *adapter;
...
# 217 "../../../component/soc/realtek/8710c/app/shell/shell.h"
...
# 236 "../../../component/soc/realtek/8710c/app/shell/shell.h"
...
# 32 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 2
...
# 36 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 2




# 39 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
...
int32_t cmd_dump_byte(uint32_t argc, uint8_t *argv[])
{
    ...
    if(argc<1) {
        (stdio_printf_stubs.rt_printfl("Wrong argument number!\r\n"));
        return 0;
    }

    src = strtoul((const char*)(argv[0]), (char **)
# 55 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                  ((void *)0)
# 55 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                      , 16);

    if(!argv[1]) {
        len = 16;
    } else {
        len = strtoul((const char*)(argv[1]), (char **)
# 60 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                      ((void *)0)
# 60 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                          , 10);
    }
...
int32_t cmd_dump_helfword(uint32_t argc, uint8_t *argv[])
{
    ...
    if(argv[0]) {
        src= strtoul((const char*)(argv[0]), (char **)
# 80 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                     ((void *)0)
# 80 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                         , 16);
    } else {
        (stdio_printf_stubs.rt_printfl("Wrong argument number!\r\n"));
        return 0;
    ...
    if(!argv[1]) {
        ...
        len = strtoul((const char*)(argv[1]), (char **)
# 89 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                      ((void *)0)
# 89 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                          , 10);
    }
    ...
    for(i = 0; i < len; i+=4, src+=16) {
        (stdio_printf_stubs.rt_printfl("%08X:  %04X    %04X    %04X    %04X    %04X    %04X    %04X    %04X\r\n", src, *(uint16_t *)(src), *(uint16_t *)(src+2), *(uint16_t *)(src+4), *(uint16_t *)(src+6), *(uint16_t *)(src+8), *(uint16_t *)(src+10), *(uint16_t *)(src+12), *(uint16_t *)(src+14)))
...
int32_t cmd_dump_word(uint32_t argc, uint8_t *argv[])
{
    ...
    if(argv[0]) {
        src= strtoul((const char*)(argv[0]), (char **)
# 119 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                     ((void *)0)
# 119 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                         , 16);
    } else {
        (stdio_printf_stubs.rt_printfl("Wrong argument number!\r\n"));
        return 0;
    ...
    if(!argv[1]) {
        ...
        len = strtoul((const char*)(argv[1]), (char **)
# 128 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                      ((void *)0)
# 128 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                          , 10);
    }
    ...
    for(i = 0; i < len; i+=4, src+=16) {
        (stdio_printf_stubs.rt_printfl("%08X:    %08X", src, *(uint32_t *)(src)));
        (stdio_printf_stubs.rt_printfl("    %08X", *(uint32_t *)(src+4)));
        (stdio_printf_stubs.rt_printfl("    %08X", *(uint32_t *)(src+8)));
        (stdio_printf_stubs.rt_printfl("    %08X\r\n", *(uint32_t *)(src+12)));
    }
    return (!0);
}
...
int32_t cmd_write_byte(uint32_t argc, uint8_t *argv[])
{
    ...
    src = strtoul((const char*)(argv[0]), (char **)
# 150 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                  ((void *)0)
# 150 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                      , 16);

    for(i=0;i<argc-1;i++,src++) {
        value= strtoul((const char*)(argv[i+1]), (char **)
# 153 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                         ((void *)0)
# 153 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                             , 16);
        (stdio_printf_stubs.rt_printfl("0x%08X = 0x%02X\r\n", src, value));
...
int32_t cmd_write_word(uint32_t argc, uint8_t *argv[])
{
    ...
    src = strtoul((const char*)(argv[0]), (char **)
# 166 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                  ((void *)0)
# 166 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                      , 16);
    while ( (src) & 0x03) {
        src++;
    }
    ...
    for(i = 0; i < (argc - 1); i++,src+=4) {
        value= strtoul((const char*)(argv[i+1]), (char **)
# 172 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c" 3 4
                                                         ((void *)0)
# 172 "../../../component/soc/realtek/8710c/app/shell/ram_s/consol_cmds.c"
                                                             , 16);
        (stdio_printf_stubs.rt_printfl("0x%08X = 0x%08X\r\n", src, value));
