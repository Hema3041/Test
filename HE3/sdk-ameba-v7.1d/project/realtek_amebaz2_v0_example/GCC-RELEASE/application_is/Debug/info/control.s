...
.Ltext0:
	...
	.section	.text.unpackAWSIoT,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	unpackAWSIoT
	.syntax unified
	...
	.thumb_func
	.fpu softvfp
	.type	unpackAWSIoT, %function
unpackAWSIoT:
.LFB560:
	.file 1 "../src/hoags/awsiot/src/control.c"
	.loc 1 63 0
	.cfi_startproc
...
.LVL5:
	.loc 1 69 0
	ldrh	ip, [r4, #1]	@ unaligned
	.loc 1 70 0
	ldrh	r7, [r4, #3]	@ unaligned
.LVL6:
	.loc 1 71 0
	ldrh	r5, [r4, #5]	@ unaligned
	.loc 1 72 0
	ldr	r0, [r4, #7]	@ unaligned
	.loc 1 73 0
	ldr	r2, [r4, #17]	@ unaligned
	.loc 1 74 0
	...
	rev16	ip, ip
	.loc 1 72 0
	str	r0, [r4, #7]	@ unaligned
	.loc 1 73 0
	str	r2, [r4, #17]	@ unaligned
	.loc 1 76 0
	mov	r1, r6
	.loc 1 69 0
	strh	ip, [r4, #1]	@ unaligned
	.loc 1 70 0
	strh	r7, [r4, #3]	@ unaligned
	.loc 1 71 0
	strh	r5, [r4, #5]	@ unaligned
	.loc 1 74 0
	str	r3, [r4, #21]	@ unaligned
	.loc 1 76 0
	movs	r2, #76
	.loc 1 78 0
...
.L3:
	...
	.cfi_endproc
.LFE560:
	.size	unpackAWSIoT, .-unpackAWSIoT
	.section	.text.printAWSIoT,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	printAWSIoT
	.syntax unified
...
.LVL11:
	.loc 1 84 0
	ldrh	r1, [r5, #1]	@ unaligned
	ldr	r0, .L10+4
	bl	__wrap_printf
.LVL12:
	.loc 1 85 0
	ldrh	r1, [r5, #3]	@ unaligned
	ldr	r0, .L10+8
	bl	__wrap_printf
.LVL13:
	.loc 1 86 0
	ldrh	r1, [r5, #5]	@ unaligned
	ldr	r0, .L10+12
	bl	__wrap_printf
.LVL14:
	.loc 1 87 0
	ldr	r1, [r5, #7]	@ unaligned
	ldr	r0, .L10+16
	bl	__wrap_printf
.LVL15:
	.loc 1 88 0
...
.LBE2:
	.loc 1 91 0
	ldr	r1, [r5, #17]	@ unaligned
	ldr	r0, .L10+28
	bl	__wrap_printf
.LVL20:
	.loc 1 92 0
	ldr	r1, [r5, #21]	@ unaligned
	ldr	r0, .L10+32
	bl	__wrap_printf
.LVL21:
	.loc 1 93 0
	ldrh	r2, [r5, #3]	@ unaligned
	ldrb	r3, [r5, #27]	@ zero_extendqisi2
	add	r2, r2, r5
	ldrb	r1, [r2, #20]	@ zero_extendqisi2
	ldrb	r0, [r2, #21]	@ zero_extendqisi2
	...
	ldrb	r4, [r5, #29]	@ zero_extendqisi2
.LVL22:
	str	ip, [sp, #16]
	stm	sp, {r0, r4, r6, r7}
	ldr	r0, .L10+36
...
.L10:
	...
	.cfi_endproc
.LFE561:
	.size	printAWSIoT, .-printAWSIoT
	.section	.text.controlFanAWSIoT,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	controlFanAWSIoT
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	controlFanAWSIoT, %function
controlFanAWSIoT:
.LFB562:
	.loc 1 137 0
	.cfi_startproc
...
.LBE3:
	.cfi_endproc
.LFE562:
	.size	controlFanAWSIoT, .-controlFanAWSIoT
	...
	.size	__func__.21378, 13
__func__.21378:
	.ascii	"unpackAWSIoT\000"
	.section	.rodata.controlFanAWSIoT.str1.4,"aMS",%progbits,1
	.align	2
.LC12:
	.ascii	"Hoags fan power control\012\000"
	.space	3
.LC13:
	.ascii	"Hoags fan increase speed\012\000"
	.space	2
.LC14:
	.ascii	"Hoags fan decrease speed\012\000"
	.space	2
.LC15:
	.ascii	"Hoags fan mode control\012\000"
.LC16:
	.ascii	"Hoags fan timer control\012\000"
	.space	3
.LC17:
	.ascii	"Hoags fan speed control\012\000"
	.section	.rodata.printAWSIoT.str1.4,"aMS",%progbits,1
	.align	2
.LC2:
	.ascii	"header:%02x\012\000"
	.space	3
.LC3:
...
.LC11:
	...
	.section	.rodata.unpackAWSIoT.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"%s:%d:start\012\000"
	.space	3
.LC1:
	.ascii	"%s:%d:end\012\000"
	.text
.Letext0:
	...
	.file 16 "../src/hoags/ble/include/packets.h"
	...
	.file 23 "../../../component/common/file_system/fatfs/r0.10c/include/integer.h"
	.file 24 "../../../component/common/file_system/fatfs/r0.10c/include/ff.h"
	.file 25 "../../../component/common/file_system/fatfs/fatfs_flash_api.h"
	.file 26 "../src/hoags/env/include/env.h"
	.file 27 "../../../component/soc/realtek/8710c/cmsis/cmsis-core/include/core_armv8mml.h"
	.file 28 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/include/rtl8710c.h"
	.file 29 "../../../component/soc/realtek/8710c/fwlib/include/hal_api.h"
	.file 30 "../../../component/soc/realtek/8710c/cmsis/rtl8710c/include/rtl8710c_irq.h"
	.file 31 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_syson_ctrl.h"
	.file 32 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_pin_name.h"
	.file 33 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_cache.h"
	.file 34 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_gdma.h"
	.file 35 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_uart.h"
	.file 36 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_timer.h"
	.file 37 "../../../component/soc/realtek/8710c/fwlib/include/rtl8710c_pwm.h"
	...
	.file 56 "../../../component/common/mbed/hal/pwmout_api.h"
	.file 57 "../src/hoags/device_controls/fan/include/fan.h"
...
.LASF125:
	.ascii	"_nmalloc\000"
.LASF1435:
	.ascii	"../src/hoags/awsiot/src/control.c\000"
.LASF878:
