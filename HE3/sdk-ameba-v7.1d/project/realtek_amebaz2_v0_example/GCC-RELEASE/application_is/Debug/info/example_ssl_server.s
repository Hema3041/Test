	...
	.eabi_attribute 34, 1
	.eabi_attribute 18, 4
	.file	"example_ssl_server.c"
	.text
.Ltext0:
	.cfi_sections	.debug_frame
	.section	.text.example_ssl_server_thread,"ax",%progbits
	.align	1
	.p2align 2,,3
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	example_ssl_server_thread, %function
example_ssl_server_thread:
.LFB175:
	.file 1 "../../../component/common/example/ssl_server/example_ssl_server.c"
	.loc 1 232 0
	.cfi_startproc
...
.L3:
	...
	.cfi_endproc
.LFE175:
	.size	example_ssl_server_thread, .-example_ssl_server_thread
	.section	.text.example_ssl_server,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	example_ssl_server
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	example_ssl_server, %function
example_ssl_server:
.LFB176:
	.loc 1 404 0
	.cfi_startproc
...
.L9:
	.word	.LC1
	.word	example_ssl_server_thread
	.word	.LANCHOR0
	.word	.LC2
	.cfi_endproc
.LFE176:
	.size	example_ssl_server, .-example_ssl_server
	.section	.rodata.__FUNCTION__.10464,"a",%progbits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__FUNCTION__.10464, %object
	.size	__FUNCTION__.10464, 19
__FUNCTION__.10464:
	.ascii	"example_ssl_server\000"
	.section	.rodata.example_ssl_server.str1.4,"aMS",%progbits,1
	.align	2
.LC1:
	.ascii	"example_ssl_server_thread\000"
	.space	2
.LC2:
	.ascii	"\012\015%s xTaskCreate example_ssl_server_thread fa"
	.ascii	"iled\000"
	.section	.rodata.example_ssl_server_thread.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"MBEDTLS_BIGNUM_C and/or MBEDTLS_CERTS_C and/or MBED"
	.ascii	"TLS_SSL_TLS_C and/or MBEDTLS_SSL_SRV_C and/or MBEDT"
	.ascii	"LS_RSA_C and/or MBEDTLS_NET_C and/or MBEDTLS_PEM_PA"
	.ascii	"RSE_C and/or MBEDTLS_X509_CRT_PARSE_C not defined.\012"
	.ascii	"\000"
	.text
.Letext0:
	...
	.file 22 "../../../component/common/network/lwip/lwip_v2.0.2/src/include/lwip/timeouts.h"
	...
	.file 26 "../../../component/common/network/lwip/lwip_v2.0.2/src/include/lwip/priv/memp_priv.h"
	...
	.file 29 "../../../component/common/drivers/wlan/realtek/include/autoconf.h"
	...
	.file 32 "../../../component/common/network/ssl/mbedtls-2.4.0/include/mbedtls/x509_crt.h"
	.file 33 "../../../component/common/network/ssl/mbedtls-2.4.0/include/mbedtls/certs.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	example_ssl_server_thread
	.uleb128 0x2b
	.byte	0x1
	.byte	0x51
	.byte	0x5
...
.LASF61:
	.ascii	"_close\000"
.LASF305:
	.ascii	"../../../component/common/example/ssl_server/exampl"
	.ascii	"e_ssl_server.c\000"
.LASF287:
