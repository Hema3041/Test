# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c" 2
# 42 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
extern hal_efuse_func_stubs_t hal_efuse_stubs;
# 52 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_efuse_autoload_en(uint8_t enable)
{
    return hal_efuse_stubs.hal_efuse_autoload_en(enable, 0x0);
}
# 65 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_efuse_hci_autoload_en(uint8_t enable)
{
    return hal_efuse_stubs.hal_efuse_hci_autoload_en(enable, 0x0);
}
# 80 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_efuse_read (uint16_t addr, uint8_t *pdata, uint8_t l25out_voltage)
{
    return hal_efuse_stubs.hal_efuse_read((uint32_t)(0x33300000), addr, pdata, l25out_voltage);
}
# 95 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_efuse_write (uint16_t addr, uint8_t data, uint8_t l25out_voltage)
{
    return hal_efuse_stubs.hal_efuse_write((uint32_t)(0x33300000), addr, data, l25out_voltage);
}
# 110 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_sec_efuse_read(uint16_t addr, uint8_t *pdata, uint8_t l25out_voltage)
{
    return hal_efuse_stubs.hal_sec_efuse_read((uint32_t)(0x33300000), addr, pdata, l25out_voltage);
}
# 125 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_sec_efuse_write(uint16_t addr, uint8_t data, uint8_t l25out_voltage)
{
    return hal_efuse_stubs.hal_sec_efuse_write((uint32_t)(0x33300000), addr, data, l25out_voltage);
}
# 140 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_sec_key_get(uint8_t *psec_key, uint8_t key_num, uint32_t length)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_sec_key_get((uint32_t)(0x33300000), psec_key, key_num, length, l25out_voltage);
}
# 155 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_sec_key_write(uint8_t *psec_key, uint8_t key_num)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_sec_key_write((uint32_t)(0x33300000), psec_key, key_num, l25out_voltage);
}
# 169 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_susec_key_get(uint8_t *psusec_key)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_susec_key_get((uint32_t)(0x33300000), psusec_key, l25out_voltage);
}
# 183 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_susec_key_write(uint8_t *psusec_key)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_susec_key_write((uint32_t)(0x33300000), psusec_key, l25out_voltage);
}
# 197 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_s_jtag_key_write(uint8_t *pkey)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_s_jtag_key_write((uint32_t)(0x33300000), pkey, l25out_voltage);
}
# 211 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_ns_jtag_key_write(uint8_t *pkey)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_ns_jtag_key_write((uint32_t)(0x33300000), pkey, l25out_voltage);
}
# 225 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_user_otp_get(uint8_t *puser_otp)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_user_otp_get((uint32_t)(0x33300000), puser_otp, l25out_voltage);
}
# 239 "../../../component/soc/realtek/8710c/fwlib/source/ram_s/hal_efuse.c"
uint32_t hal_user_otp_set(uint8_t *puser_otp)
{
    uint8_t l25out_voltage = 0x0;
    return hal_efuse_stubs.hal_user_otp_set((uint32_t)(0x33300000), puser_otp, l25out_voltage);
}
...
uint32_t hal_efuse_disable_sec_jtag (void)
{
    return hal_efuse_stubs.hal_efuse_write((uint32_t)(0x33300000), 0x00, 0xF3, 0x0);
}
...
uint32_t hal_efuse_disable_nonsec_jtag (void)
{
    return hal_efuse_stubs.hal_efuse_write((uint32_t)(0x33300000), 0x00, 0xCF, 0x0);
}
