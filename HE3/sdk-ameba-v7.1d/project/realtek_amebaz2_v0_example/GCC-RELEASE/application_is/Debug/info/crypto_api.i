# 1 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
# 29 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
...
# 30 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 2
...
# 35 "../../../component/soc/realtek/8710c/fwlib/include/hal_crypto.h" 2
...
# 42 "../../../component/soc/realtek/8710c/fwlib/include/hal_crypto.h" 2
...
# 31 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 2
...
# 32 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 2
...
# 33 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 2
# 45 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
int crypto_init(void)
{
    int ret;
...
int xip_flash_remap_check(const uint8_t *ori_addr, uint32_t *remap_addr, const uint32_t buf_len) {
    ...
    if (((uint32_t)ori_addr >= (0x98000000)) && ((uint32_t)ori_addr < (0x9C000000))) {

        if ((0x00) == hal_xip_get_phy_addr((uint32_t)ori_addr, &xip_phy_addr, (uint32_t *)&pis_enc)) {
...
# 95 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
int crypto_md5(const uint8_t *message, const uint32_t msglen, uint8_t *pDigest)
{
    int ret;
    uint32_t msg_addr;
...
# 1148 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
static int crypto_hkdf_extract (const uint8_t *salt, size_t salt_len, const uint8_t *ikm, size_t ikm_len, uint8_t *prk)
{
    ...
    if (salt == 
# 1153 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 3 4
               ((void *)0)
# 1153 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
                   ) {
        salt = (uint8_t *)(((((uint32_t)null_salt - 1) >> 5) + 1) << 5);
        salt_len = 32;
                                ...
                                uint8_t *okm, size_t okm_len )
{
    ...
    t = (uint8_t *)(((((uint32_t)t_buf - 1) >> 5) + 1) << 5);

    if(info == 
# 1191 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 3 4
              ((void *)0)
# 1191 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
                  ) {
    ...
    for (i = 1; i <= n; i++)
    {
        ...
        if ((info_len > 0) && (info != 
# 1232 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 3 4
                                      ((void *)0)
# 1232 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
                                          )) {
...
int crypto_random_seed (uint8_t *seed_buf, uint32_t seed_size)
{
    ...
    if ((seed_size == 0) || (seed_buf == 
# 1302 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 3 4
                                        ((void *)0)
# 1302 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
                                            )) {
        return -30;
    }
    ...
    loop_cnt = seed_size << 3;
    pvrn = seed_buf;
    ret = hal_timer_init (&ls_timer, GTimer8);
    if (ret != (0x00)) {
        (stdio_printf_stubs.rt_printfl("%s: LS Timer init error(0x%x)\r\n", __func__, ret));
        return ret;
    }

    hal_timer_start_periodical (&ls_timer, ls_tick_time, (timer_callback_t)random_seed_timer_callback, 
# 1316 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c" 3 4
                                                                                                      ((void *)0)
# 1316 "../../../component/common/mbed/targets/hal/rtl8710c/crypto_api.c"
                                                                                                          );
    vrng_idx = 0;
    *pvrn = 0;
...
int crypto_random_generate (uint8_t *rn_buf, uint32_t rn_size)
{
    ...
    ret = crypto_random_seed (pkey_buf,32);
    if (ret != 0) {
        goto __random_generate_exit;
    }
    ret = crypto_random_seed (pnonce,16);
    if (ret != 0) {
        goto __random_generate_exit;
    }

    psalt = (uint8_t *)(((((uint32_t)salt - 1) >> 5) + 1) << 5);
    ret = crypto_random_seed (psalt,32);
    if (ret != 0) {
        goto __random_generate_exit;
    }
    ...
    ret = crypto_hkdf_derive (psalt, 32, pkey_buf, 32, pnonce, 16, rn_buf, rn_size);
    if (ret != 0) {
        goto __random_generate_exit;
    }
__random_generate_exit:

    memset(key_buf, 0, 32 +31);
    memset(nonce, 0, 16 +31);
