...
port_init:
.LFB559:
	.file 1 "../../../component/common/mbed/targets/hal/rtl8710c/port_api.c"
	.loc 1 59 0
	.cfi_startproc
...
.LFE559:
	...
	.section	.text.port_dir,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	port_dir
	.syntax unified
...
.LVL11:
	.cfi_endproc
.LFE560:
	.size	port_dir, .-port_dir
	.section	.text.port_mode,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	port_mode
	.syntax unified
...
.LFE563:
	...
	.section	.rodata.port_init.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"\015[GPIO Err]port_init error (%d)\015\012\000"
	.text
.Letext0:
	...
	.file 35 "../../../component/common/mbed/targets/hal/rtl8710c/PortNames.h"
	...
	.file 49 "../../../component/common/mbed/hal/port_api.h"
...
.LASF1203:
	.ascii	"hal_gpio_port_adapter_t\000"
.LASF88:
	.ascii	"_freelist\000"
.LASF1042:
