# 1 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
# 30 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
...
# 31 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 2



# 1 "../../../component/common/mbed/hal_ext/spdio_api.h" 1
# 20 "../../../component/common/mbed/hal_ext/spdio_api.h"
...
# 21 "../../../component/common/mbed/hal_ext/spdio_api.h" 2
# 47 "../../../component/common/mbed/hal_ext/spdio_api.h"
...
struct spdio_buf_t{
 void *priv;
 uint32_t buf_allocated;
 uint16_t size_allocated;
 uint32_t buf_addr;
 uint16_t buf_size;
 uint8_t type;
 uint8_t reserved;
...
struct spdio_t {
 ...
 uint32_t tx_bd_num;
 uint32_t rx_bd_num;
 uint32_t rx_bd_bufsz;
 struct spdio_buf_t *rx_buf;
# 88 "../../../component/common/mbed/hal_ext/spdio_api.h"
 char (*rx_done_cb)(void *priv, void* pbuf, uint8_t *pdata, uint16_t size, uint8_t type);
# 97 "../../../component/common/mbed/hal_ext/spdio_api.h"
...
# 117 "../../../component/common/mbed/hal_ext/spdio_api.h"
...
# 35 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 2
...
# 36 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 2

struct spdio_t *g_spdio_priv = 
# 37 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
                              ((void *)0)
# 37 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                                  ;
...
int8_t spdio_rx_done_cb (void *padapter, uint8_t *data, uint16_t offset, uint16_t pktsize, uint8_t type)
{
 ...
 if(obj) {
  ...
  __wrap_printf("spdio rx done callback function is null!""\r\n");
    }
 return 0;
}
...
int8_t spdio_tx_done_cb (void *padapter, void *data, uint16_t offset, uint16_t pktsize, uint8_t type)
{
 ...
 if(obj) {
  ...
  __wrap_printf("spdio tx done callback function is null!""\r\n");
    }
 return 0;
}
...
void spdio_structinit(struct spdio_t *obj)
{
 obj->rx_bd_bufsz = ((((2048+24 -1)>>6)+1)<<6);
 obj->rx_bd_num = 24;
 obj->tx_bd_num = 24;
 obj->priv = 
# 75 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
            ((void *)0)
# 75 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                ;
 obj->rx_buf = 
# 76 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
              ((void *)0)
# 76 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                  ;
 obj->rx_done_cb = 
# 77 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
                  ((void *)0)
# 77 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                      ;
 obj->tx_done_cb = 
# 78 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
                  ((void *)0)
# 78 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                      ;
}
...
{
 if(obj == 
# 83 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
          ((void *)0)
# 83 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
              ){
  __wrap_printf("spdio obj is NULL, spdio init failed!""\r\n");
  return;
 }

 if((obj->rx_bd_num == 0) ||(obj->rx_bd_bufsz == 0) || (obj->rx_bd_bufsz%64)
  ||(obj->tx_bd_num == 0) ||(obj->tx_bd_num%2)||(obj->rx_buf == 
# 89 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
                                                               ((void *)0)
# 89 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                                                                   ))
 {
  __wrap_printf("spdio obj resource isn't correctly inited, spdio init failed!""\r\n");
  return;
 }
...
{
 if(obj == 
# 103 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
          ((void *)0)
# 103 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
              ){
  __wrap_printf("spdio obj is NULL, spdio deinit failed""\r\n");
  return;
 }

 hal_sdio_dev_deinit();
 g_spdio_priv = 
# 109 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c" 3 4
               ((void *)0)
# 109 "../../../component/common/mbed/targets/hal/rtl8710c/spdio_api.c"
                   ;
}
