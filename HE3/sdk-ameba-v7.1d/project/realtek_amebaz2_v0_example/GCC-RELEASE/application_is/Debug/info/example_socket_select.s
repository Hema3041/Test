	...
	.eabi_attribute 34, 1
	.eabi_attribute 18, 4
	.file	"example_socket_select.c"
	.text
.Ltext0:
	.cfi_sections	.debug_frame
	.section	.text.example_socket_select_thread,"ax",%progbits
	.align	1
	.p2align 2,,3
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	example_socket_select_thread, %function
example_socket_select_thread:
.LFB146:
	.file 1 "../../../component/common/example/socket_select/example_socket_select.c"
	.loc 1 18 0
	.cfi_startproc
...
.LBE13:
	.cfi_endproc
.LFE146:
	.size	example_socket_select_thread, .-example_socket_select_thread
	.section	.text.example_socket_select,"ax",%progbits
	.align	1
	.p2align 2,,3
	.global	example_socket_select
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	example_socket_select, %function
...
.L73:
	.word	.LC8
	.word	example_socket_select_thread
	.word	.LANCHOR0
	.word	.LC9
	.cfi_endproc
.LFE147:
	.size	example_socket_select, .-example_socket_select
	.section	.rodata.__FUNCTION__.7270,"a",%progbits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__FUNCTION__.7270, %object
	.size	__FUNCTION__.7270, 22
__FUNCTION__.7270:
	.ascii	"example_socket_select\000"
	.section	.rodata.example_socket_select.str1.4,"aMS",%progbits,1
	.align	2
.LC8:
	.ascii	"example_socket_select_thread\000"
	.space	3
.LC9:
	.ascii	"\012\015%s xTaskCreate(init_thread) failed\000"
	.section	.rodata.example_socket_select_thread.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"\012Example: socket select\012\000"
	.space	3
.LC1:
	.ascii	"bind error\012\000"
.LC2:
	.ascii	"listen error\012\000"
	.space	2
.LC3:
	.ascii	"socket error\012\000"
	.space	2
.LC4:
	.ascii	"accept socket fd(%d)\012\000"
	.space	2
.LC5:
	.ascii	"accept error\012\000"
	.space	2
.LC6:
	.ascii	"socket fd(%d) disconnected\012\000"
.LC7:
	.ascii	"TCP server: no data in %d seconds\012\000"
	.text
.Letext0:
	...
	.file 29 "../../../component/os/freertos/freertos_v10.0.1/Source/include/task.h"
	.file 30 "../../../component/common/api/platform/platform_stdlib_rtl8710c.h"
	.file 31 "../../../component/common/network/lwip/lwip_v2.0.2/src/include/lwip/def.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	example_socket_select_thread
	.uleb128 0x27
	.byte	0x1
	.byte	0x51
	.byte	0x5
...
.LASF252:
	.ascii	"example_socket_select\000"
.LASF249:
	.ascii	"../../../component/common/example/socket_select/exa"
	.ascii	"mple_socket_select.c\000"
.LASF161:
