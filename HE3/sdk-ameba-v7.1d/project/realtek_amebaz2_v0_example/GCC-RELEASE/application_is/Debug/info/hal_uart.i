# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
# 29 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
...
# 30 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_uart.h" 1
# 33 "../../../component/soc/realtek/8710c/fwlib/include/hal_uart.h"
...
# 34 "../../../component/soc/realtek/8710c/fwlib/include/hal_uart.h" 2
...
hal_status_t hal_uart_dma_recv (phal_uart_adapter_t puart_adapter, uint8_t *prx_buf, uint32_t len);
hal_status_t hal_uart_dma_send (phal_uart_adapter_t puart_adapter, uint8_t *ptx_buf, uint32_t len);
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
hal_status_t hal_pinmux_unregister (uint8_t pin_name, uint8_t periphl_id);
# 33 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 34 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 35 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 36 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 37 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
# 38 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 2
...
uint8_t hal_uart_check_uart_id (uint8_t tx_pin, uint8_t rx_pin)
{
    ...
    if (tx_pin != PIN_NC) {
        ...
        if (uart_idx >= 4) {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "%s: pin(0x%x) is not for UART TX\r\n", __func__, tx_pin));}while(0);
            return (0xFF);
        }
    }
    ...
    if (rx_pin != PIN_NC) {
        if (uart_idx != 0xFF) {
            if (uart_idx != hal_uart_stubs.hal_uart_pin_to_idx (rx_pin, UART_Pin_RX)) {
                do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "%s:tx_pin(0x%x) & rx_pin(0x%x) is not on the same UART\r\n", __func__, tx_pin, rx_pin));}while(0);
                return (0xFF);
            }
        } else {
            uart_idx = hal_uart_stubs.hal_uart_pin_to_idx (rx_pin, UART_Pin_RX);
            if (uart_idx >= 4) {
                do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "%s: pin(0x%x) is not for UART RX\r\n", __func__, rx_pin));}while(0);
                return (0xFF);
            }
        }
    }
...
# 102 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_init (phal_uart_adapter_t puart_adapter, uint8_t tx_pin, uint8_t rx_pin,
                            phal_uart_defconfig_t pconfig)
{
    hal_status_t ret;
...
# 151 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
void hal_uart_deinit (phal_uart_adapter_t puart_adapter)
{
...
# 188 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_set_flow_control (phal_uart_adapter_t puart_adapter, uint32_t flow_ctrl)
{
...
# 248 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_tx_gdma_init(phal_uart_adapter_t puart_adapter, phal_gdma_adaptor_t pgdma_chnl)
{
    hal_status_t ret;

 rt_memset((void *)pgdma_chnl, 0, sizeof(hal_gdma_adaptor_t));
    ret = hal_gdma_chnl_alloc (pgdma_chnl);
    ...
    if (ret == (0x00)) {
        ...
        if (ret == (0x00)) {
            ...
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_tx_gdma_init: GDMA init failed(%d)\r\n", ret));}while(0);
            hal_gdma_chnl_free (pgdma_chnl);
        }
    } else {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_tx_gdma_init: GDMA channel allocate failed(%d)\r\n", ret));}while(0);
    }

    return ret;
}
# 280 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_tx_gdma_deinit(phal_uart_adapter_t puart_adapter)
{
    hal_gdma_chnl_free (puart_adapter->ptx_gdma);
    return hal_uart_stubs.hal_uart_tx_gdma_deinit(puart_adapter);
}
# 296 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_rx_gdma_init(phal_uart_adapter_t puart_adapter, phal_gdma_adaptor_t pgdma_chnl)
{
    hal_status_t ret;
 ...
 rt_memset((void *)pgdma_chnl, 0, sizeof(hal_gdma_adaptor_t));
    ...
    if (ret == (0x00)) {
        ...
        if (ret == (0x00)) {
            ...
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_rx_gdma_init: GDMA init failed(%d)\r\n", ret));}while(0);
            hal_gdma_chnl_free (pgdma_chnl);
        }
    } else {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_rx_gdma_init: GDMA channel allocate failed(%d)\r\n", ret));}while(0);
    }

    return ret;
}
# 328 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_rx_gdma_deinit(phal_uart_adapter_t puart_adapter)
{
    hal_gdma_chnl_free (puart_adapter->prx_gdma);
    return hal_uart_stubs.hal_uart_rx_gdma_deinit(puart_adapter);
}
# 347 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_dma_recv (phal_uart_adapter_t puart_adapter, uint8_t *prx_buf, uint32_t len)
{
    ...
    if (pgdma_chnl == 
# 353 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 3 4
                     ((void *)0)
# 353 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
                         ) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_dma_recv: No GDMA Chnl\r\n"));}while(0);
        return (0x08);
    }

    if (len > 4095) {
# 387 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
        {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_dma_recv: Err: RX Len(%lu) too big\n", len));}while(0);
            return (0x03);
        }
    }
    return hal_uart_stubs.hal_uart_dma_recv (puart_adapter, prx_buf, len);
}
# 407 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
hal_status_t hal_uart_dma_send (phal_uart_adapter_t puart_adapter, uint8_t *ptx_buf, uint32_t len)
{
    ...
    if (pgdma_chnl == 
# 414 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c" 3 4
                     ((void *)0)
# 414 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
                         ) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_dma_send: No GDMA Chnl\r\n"));}while(0);
        return (0x08);
    }
    ...
    if (block_size > 4095) {
# 456 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_uart.c"
        {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000800), 1)) (stdio_printf_stubs.rt_printfl("\r" "[UART Err]" "hal_uart_dma_send: Err: TX length too big(%lu)\r\n", len));}while(0);
            return (0x03);
        }
    }
