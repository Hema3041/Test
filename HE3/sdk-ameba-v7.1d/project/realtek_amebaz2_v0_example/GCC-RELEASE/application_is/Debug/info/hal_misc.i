# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
# 30 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_misc.h" 1
# 31 "../../../component/soc/realtek/8710c/fwlib/include/hal_misc.h"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/include/hal_misc.h" 2
...
void hal_misc_cpu_rst (void);
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 2
...
hal_status_t hal_pinmux_unregister (uint8_t pin_name, uint8_t periphl_id);
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 2
...
# 33 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 2
...
# 34 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 2
...
# 35 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 2

extern hal_spic_adaptor_t *pglob_spic_adaptor;
extern void hal_flash_return_spi (phal_spic_adaptor_t phal_spic_adaptor);
# 47 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
...
# 66 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
hal_status_t hal_misc_swd_pin_ctrl (BOOL en)
{
    hal_status_t ret;
...
# 100 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
hal_status_t hal_misc_jtag_pin_ctrl (BOOL en)
{
    hal_status_t ret;
    uint8_t *pin;
    ...
    if (en) {
        for (i=0; i<sizeof(jtag_pins); i++) {
            ...
            if (ret == (0x00)) {
                ...
                do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x40000000), 1)) (stdio_printf_stubs.rt_printfl("\r" "[MISC Err]" "JTAG pin 0x%x reg err\r\n", *(pin+i)));}while(0);
                pin = (uint8_t *)&jtag_pins;
...
# 144 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
void hal_misc_cpu_rst (void)
{
    rtl8710c_reset_reason_set(HAL_RESET_REASON_SOFTWARE);

    if (pglob_spic_adaptor != 
# 148 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c" 3 4
                             ((void *)0)
# 148 "../../../component/soc/realtek/8710c/fwlib/source/ram/hal_misc.c"
                                 ) {
