# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
...
# 1 "<command-line>" 2
# 1 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
# 29 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
# 1 "../../../component/soc/realtek/8710c/fwlib/include/hal_flash.h" 1
# 31 "../../../component/soc/realtek/8710c/fwlib/include/hal_flash.h"
...
# 32 "../../../component/soc/realtek/8710c/fwlib/include/hal_flash.h" 2
...
# 30 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c" 2
...
# 31 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c" 2
...
# 32 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c" 2
...
# 33 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c" 2
...
# 34 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c" 2
...
# 108 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_read_unique_id (phal_spic_adaptor_t phal_spic_adaptor, uint8_t *buf, uint8_t len)
{
    hal_flash_stubs.hal_flash_read_unique_id(phal_spic_adaptor, buf, len);
}
# 124 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
hal_status_t hal_flash_read_id (phal_spic_adaptor_t phal_spic_adaptor)
{
    return hal_flash_stubs.hal_flash_read_id(phal_spic_adaptor);
}
# 138 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_write_enable (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_set_write_enable(phal_spic_adaptor);
}
# 156 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_status (phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t data)
{
    hal_flash_stubs.hal_flash_set_status(phal_spic_adaptor, cmd, data);
}
# 174 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_status_no_check (phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t data)
{
    hal_flash_stubs.hal_flash_set_status_no_check(phal_spic_adaptor, cmd, data);
}
# 194 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_status_with_addr (phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t addr, uint8_t data)
{
    hal_flash_stubs.hal_flash_set_status_with_addr(phal_spic_adaptor, cmd, addr, data);
}
# 212 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_extended_addr (phal_spic_adaptor_t phal_spic_adaptor, uint8_t data)
{
    hal_flash_stubs.hal_flash_set_extended_addr(phal_spic_adaptor, data);
}
# 230 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_write_protect_mode (phal_spic_adaptor_t phal_spic_adaptor, uint8_t mode)
{
    hal_flash_stubs.hal_flash_set_write_protect_mode(phal_spic_adaptor, mode);
}
# 246 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
uint8_t hal_flash_get_status (phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd)
{
    return hal_flash_stubs.hal_flash_get_status(phal_spic_adaptor, cmd);
}
# 264 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
uint8_t hal_flash_get_status_with_addr (phal_spic_adaptor_t phal_spic_adaptor, uint8_t cmd, uint8_t addr)
{
    return hal_flash_stubs.hal_flash_get_status_with_addr(phal_spic_adaptor, cmd, addr);
}
# 279 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
uint8_t hal_flash_get_extended_addr (phal_spic_adaptor_t phal_spic_adaptor)
{
    return hal_flash_stubs.hal_flash_get_extended_addr(phal_spic_adaptor);
}
# 293 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_wait_ready (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_wait_ready(phal_spic_adaptor);
}
# 307 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_chip_erase (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_chip_erase(phal_spic_adaptor);
}
# 323 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_64k_block_erase (phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    hal_flash_stubs.hal_flash_64k_block_erase(phal_spic_adaptor, address);
}
# 339 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_32k_block_erase (phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    hal_flash_stubs.hal_flash_32k_block_erase(phal_spic_adaptor, address);
}
# 355 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_sector_erase (phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    hal_flash_stubs.hal_flash_sector_erase(phal_spic_adaptor, address);
}
# 371 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
uint8_t hal_flash_query_sector_protect_state(phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    return hal_flash_stubs.hal_flash_query_sector_protect_state(phal_spic_adaptor, address);
}
# 388 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_protect_sector (phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    hal_flash_stubs.hal_flash_protect_sector(phal_spic_adaptor, address);
}
# 405 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_unprotect_sector (phal_spic_adaptor_t phal_spic_adaptor, uint32_t address)
{
    hal_flash_stubs.hal_flash_unprotect_sector(phal_spic_adaptor, address);
}
# 420 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_global_lock (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_global_lock(phal_spic_adaptor);
}
# 435 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_global_unlock (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_global_unlock(phal_spic_adaptor);
}
# 451 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_dummy_cycle (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_set_dummy_cycle(phal_spic_adaptor);
}
# 466 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_set_quad_enable (phal_spic_adaptor_t phal_spic_adaptor)
{
    ...
    switch (flash_type) {
        ...
        default:
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "Unknown flash type, cannot set QE bit!\n"));}while(0);
    }
}
# 524 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_unset_quad_enable (phal_spic_adaptor_t phal_spic_adaptor)
{
    pflash_cmd_t cmd = phal_spic_adaptor->cmd;
    uint8_t flash_type = phal_spic_adaptor->flash_type;
    ...
    switch (flash_type) {
        ...
        default:
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "Unknown flash type, cannot reset QE bit!\n"));}while(0);
    }
}
# 577 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_enable_qpi (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_enable_qpi(phal_spic_adaptor);
}
# 594 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_return_spi (phal_spic_adaptor_t phal_spic_adaptor)
{
    pflash_cmd_t cmd = phal_spic_adaptor->cmd;
...
# 656 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
hal_status_t hal_flash_enter_power_down (phal_spic_adaptor_t phal_spic_adaptor)
{
    return hal_flash_stubs.hal_flash_enter_power_down(phal_spic_adaptor);
}
# 671 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
hal_status_t hal_flash_release_from_power_down (phal_spic_adaptor_t phal_spic_adaptor)
{
    return hal_flash_stubs.hal_flash_release_from_power_down(phal_spic_adaptor);
}
# 687 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_stream_read (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    hal_flash_stubs.hal_flash_stream_read(phal_spic_adaptor, length, addr, data);
}
# 703 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_stream_write (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    hal_flash_stubs.hal_flash_stream_write(phal_spic_adaptor, length, addr, data);
}
# 719 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_burst_read (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    hal_flash_stubs.hal_flash_burst_read(phal_spic_adaptor, length, addr, data);
}
# 735 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_burst_write (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    ...
    if ((((uint32_t)(data)) >> 24) == 0x9B) {
        ...
        if (is_encry) {
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "Source address should not be on the encryted remapping region!\r\n"));}while(0);
            return;
        } else {
...
# 806 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_page_program (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    hal_flash_stubs.hal_flash_page_program(phal_spic_adaptor, length, addr, data);
}
# 823 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_read_write_flash (phal_spic_adaptor_t phal_spic_adaptor, uint32_t length, uint32_t addr, uint8_t *data)
{
    SPIC_Type *spic_dev = phal_spic_adaptor->spic_dev;
    pflash_cmd_t cmd = phal_spic_adaptor->cmd;
    ...
    switch (spic_send_cmd_mode) {
        ...
        default:
            do { if (__builtin_expect (((*(utility_stubs.config_debug_err)) & 0x00000100), 1)) (stdio_printf_stubs.rt_printfl("\r" "[SPIF Err]" "Wrong IO Mode to program!\n"));}while(0);
    }

    spic_dev->ctrlr0 = ctrlr0.w;


    spic_dev->ctrlr2_b.seq_en = 1;
    ...
    spic_dev->ctrlr2_b.seq_en = 0;

    spic_dev->valid_cmd_b.prm_en = 1;
}
# 973 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_reset_to_spi (phal_spic_adaptor_t phal_spic_adaptor)
{
    hal_flash_stubs.hal_flash_reset_to_spi(phal_spic_adaptor);
}
# 986 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
void hal_flash_support_new_type (phal_spic_adaptor_t phal_spic_adaptor)
{
    ...
    switch (flash_id) {
        case 0xC8:
            ...
            if (phal_spic_adaptor->flash_id[2] >= 0x16) {
                phal_spic_adaptor->flash_type = 5;
            } else {
                phal_spic_adaptor->flash_type = 4;
            }
            break;

        case 0x0B:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 6;
            break;

        case 0x68:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 8;
            break;

        case 0x46:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 9;
            break;

        case 0x1C:
            phal_spic_adaptor->flash_type = 7;
            break;

        case 0x5E:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 10;
            break;

        case 0xEB:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 11;
            break;

        case 0x85:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 12;
            break;

        case 0xC4:
            phal_spic_adaptor->cmd = &new_flash_cmd;
            phal_spic_adaptor->flash_type = 13;
            break;
...
# 1052 "../../../component/soc/realtek/8710c/fwlib/source/ram_ns/hal_flash.c"
uint8_t hal_flash_get_size (phal_spic_adaptor_t phal_spic_adaptor)
{
    uint8_t efuse_value;
