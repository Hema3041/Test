...
#shaik:  for include files
INCLUDES += -I../src/hoags
INCLUDES += -I../src/hoags/ota_h3/include
INCLUDES += -I../src/hoags/ble/include
INCLUDES += -I../src/hoags/dataCollector/include
INCLUDES += -I../src/hoags/awsiot/include

#rehan: for include files
INCLUDES += -I../src/hoags/env/include
INCLUDES += -I../src/hoags/device_controls/fan/include
INCLUDES += -I../src/hoags/device_controls/light/include
INCLUDES += -I../src/hoags/device_controls/mic/include
INCLUDES += -I../src/hoags/device_controls/ac/include
INCLUDES += -I../src/hoags/device_controls/aircooler/include
INCLUDES += -I../src/hoags/device_controls/purifier/include
INCLUDES += -I../src/hoags/data_struct/include
INCLUDES += -I../src/hoags/device_controls/chimney/include
INCLUDES += -I../src/hoags/ui/include/
INCLUDES += -I../src/hoags/hoags_fatfs/include
INCLUDES += -I../../../component/common/file_system/fatfs/fatfs_ext/inc
INCLUDES += -I../src/hoags/fatfs/include
INCLUDES += -I../../../component/common/file_system/fatfs/disk_if/inc
INCLUDES += -I../src/hoags/ui/include
INCLUDES += -I../src/hoags/cmd/include/
# Source file list
# -------------------------------------------------------------------
...
SRC_C += ../src/hoags/cmd/src/hoags_commands.c
...
#SRC_C += ../../../component/soc/realtek/8710c/misc/platform/ota_h3.c
...
# hoags - fatfs is not used in livpure lotier.
#file_system - fatfs
...
SRC_C += ../src/main.c
#shaik:::::::::::::::::::
SRC_C += ../src/hoags/ota_h3/src/ota_h3.c
SRC_C += ../src/hoags/ble/src/packets.c
SRC_C += ../src/hoags/ble/src/ble_set_id.c


#rehan : begin 
SRC_C += ../src/hoags/device_controls/light/src/light.c
SRC_C += ../src/hoags/device_controls/light/src/LED.c
SRC_C += ../src/hoags/device_controls/fan/src/fan.c
SRC_C += ../src/hoags/device_controls/ac/src/ac.c
SRC_C += ../src/hoags/device_controls/purifier/src/cloudConnect.c
SRC_C += ../src/hoags/device_controls/purifier/src/flashWritePurifier.c
SRC_C += ../src/hoags/device_controls/purifier/src/purifier.c
SRC_C += ../src/hoags/device_controls/purifier/src/remoteDiag.c
SRC_C += ../src/hoags/device_controls/purifier/src/uart_buffered.c


# SRC_C += ../src/hoags/hoags_fatfs/src/hoagsFATFS.c
# SRC_C += ../src/hoags/fatfs/src/hfs.c

SRC_C += ../../../component/common/file_system/fatfs/fatfs_flash_api.c
SRC_C += ../src/hoags/env/src/env.c
SRC_C += ../src/hoags/awsiot/src/control.c
SRC_C += ../src/hoags/dataCollector/src/dataCollector.c
SRC_C += ../src/hoags/awsiot/src/awsiot.c

SRC_C += ../src/hoags/ui/src/htap_config.c
...
CFLAGS =
CFLAGS += -march=armv8-m.main+dsp -mthumb -mcmse -mfloat-abi=soft -D__thumb2__ -g -gdwarf-3 -O3
...
CFLAGS += -D$(CUSTOMERNAME)=1
CFLAGS += -DHOAGS_LOG_LEVEL=$(LOGLEVEL)
CFLAGS += -DFW_CAP_LEVEL=$(CAPABILITY)
CFLAGS += -DPRODUCT_MODEL_NUMBER=\"$(MODEL_NUMBER)\"
CFLAGS += -DFILTER_SETTING=$(FILTER_SETTING)
CFLAGS += -DLOG_UART_DISABLE=$(UART_LOG_DISABLE)
#CFLAGS += -DSECURED_SOC_CHECK=$(SECURESOC)

LFLAGS = 
LFLAGS += -O3 -march=armv8-m.main+dsp -mthumb -mcmse -mfloat-abi=soft -nostartfiles -nodefaultlibs -nostdlib -specs=nosys.specs
