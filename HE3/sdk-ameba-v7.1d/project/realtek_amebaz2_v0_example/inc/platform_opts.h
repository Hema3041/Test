...
*/
#define HOAGS_FLASH_SIZE    0x400000

#define FLASH_BAKEUP_SECTOR		(0x3000)
#define FAST_RECONNECT_DATA		(HOAGS_FLASH_SIZE - 0x1000)
#define BT_FTL_PHY_ADDR0		(HOAGS_FLASH_SIZE - 0x2000)
#define BT_FTL_PHY_ADDR1		(HOAGS_FLASH_SIZE - 0x3000)
#define BT_FTL_BKUP_ADDR		(HOAGS_FLASH_SIZE - 0x4000)
#define UART_SETTING_SECTOR		(HOAGS_FLASH_SIZE - 0x5000)
#define DCT_BEGIN_ADDR			(HOAGS_FLASH_SIZE - 0x29000) /*!< DCT begin address of flash, ex: 0x200000 = 2M, the default size of DCT is 24K; ; if backup enabled, the size is 48k; if wear leveling enabled, the size is 144k*/
