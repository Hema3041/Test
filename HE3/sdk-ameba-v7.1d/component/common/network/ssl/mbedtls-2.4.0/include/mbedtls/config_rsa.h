...
/* SSL options */
//Suvarna: Don't change the max length below
#define MBEDTLS_SSL_MAX_CONTENT_LEN                6144 /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
