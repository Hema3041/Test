...
#elif (TIME_MODE == 1)
	int timezone = 0;	// use UTC+8 timezone for example
...
{
	if(xTaskCreate(example_sntp_showtime_thread, ((const char*)"example_sntp_showtime_thread"), 1024 * 2, NULL, tskIDLE_PRIORITY + 1, NULL) != pdPASS)
